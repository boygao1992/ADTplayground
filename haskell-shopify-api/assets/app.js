              ...
              var go = function (v1) {
                  ...
                  if (v1 instanceof Subscribe) {
                      return new Subscribe(function ($139) {
                          return Halogen_Query_EventSource.hoist(dictFunctor)(nat)(v1.value0($139));
                      }, v1.value1);
                  };
                  ...
                  throw new Error("Failed pattern match at Halogen.Query.HalogenM (line 279, column 8 - line 289, column 28): " + [ v1.constructor.name ]);
              };
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Capability.Navigate"] = $PS["Polaris.UI.Capability.Navigate"] || {};
  var exports = $PS["Polaris.UI.Capability.Navigate"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Data.Route"] = $PS["Polaris.UI.Data.Route"] || {};
  var exports = $PS["Polaris.UI.Data.Route"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof Catalog) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
      if (x instanceof Config) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value)));
      };
      throw new Error("Failed pattern match at Polaris.UI.Data.Route (line 16, column 8 - line 16, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      Company: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("company")(Routing_Duplex_Generic.noArgs),
      Catalog: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("catalog")(Routing_Duplex_Generic.noArgs),
      Config: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("config")(Routing_Duplex_Generic.noArgs)
  }));     
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Company && y instanceof Company) {
              return true;
          };
          if (x instanceof Catalog && y instanceof Catalog) {
              return true;
          };
          if (x instanceof Config && y instanceof Config) {
              return true;
          };
          return false;
      };
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.AppM"] = $PS["Polaris.UI.AppM"] || {};
  var exports = $PS["Polaris.UI.AppM"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Polaris_UI_Capability_Navigate = $PS["Polaris.UI.Capability.Navigate"];
  var Polaris_UI_Data_Route = $PS["Polaris.UI.Data.Route"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  ...
  var navigateAppM = new Polaris_UI_Capability_Navigate.Navigate(function () {
      return monadAppM;
  }, function ($4) {
      return Effect_Class.liftEffect(monadEffectAppM)(Routing_Hash.setHash(Routing_Duplex.print(Polaris_UI_Data_Route.routeCodec)($4)));
  });
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Page.Catalog"] = $PS["Polaris.UI.Page.Catalog"] || {};
  var exports = $PS["Polaris.UI.Page.Catalog"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Catalog") ]) ]);
  };                                       
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Page.Company"] = $PS["Polaris.UI.Page.Company"] || {};
  var exports = $PS["Polaris.UI.Page.Company"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Company") ]) ]);
  };                                       
  var component = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Page.Config"] = $PS["Polaris.UI.Page.Config"] || {};
  var exports = $PS["Polaris.UI.Page.Config"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Config") ]) ]);
  };                                       
  var component = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Page.Home"] = $PS["Polaris.UI.Page.Home"] || {};
  var exports = $PS["Polaris.UI.Page.Home"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Home") ]) ]);
  };                                       
  var component = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Polaris.UI.Router"] = $PS["Polaris.UI.Router"] || {};
  var exports = $PS["Polaris.UI.Router"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Polaris_UI_Capability_Navigate = $PS["Polaris.UI.Capability.Navigate"];
  var Polaris_UI_Data_Route = $PS["Polaris.UI.Data.Route"];
  var Polaris_UI_Page_Catalog = $PS["Polaris.UI.Page.Catalog"];
  var Polaris_UI_Page_Company = $PS["Polaris.UI.Page.Company"];
  var Polaris_UI_Page_Config = $PS["Polaris.UI.Page.Config"];
  var Polaris_UI_Page_Home = $PS["Polaris.UI.Page.Home"];                
  ...
  var handleAction = function (dictNavigate) {
      return function (v) {
          return Polaris_UI_Capability_Navigate.navigate(Polaris_UI_Capability_Navigate.navigateHalogenM(dictNavigate))(v.value0);
      };
  };
  var defaultInitialState = {
      route: Polaris_UI_Data_Route.Home.value
  };
  var _home = Data_Symbol.SProxy.value;
  var _config = Data_Symbol.SProxy.value;
  var _company = Data_Symbol.SProxy.value;
  var _catalog = Data_Symbol.SProxy.value;
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function ($18) {
          return Data_Maybe.Just.create(Data_Function["const"](new RouteTo(Polaris_UI_Data_Route.Home.value))($18));
      }) ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function ($19) {
          return Data_Maybe.Just.create(Data_Function["const"](new RouteTo(Polaris_UI_Data_Route.Company.value))($19));
      }) ])([ Halogen_HTML_Core.text("Company") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function ($20) {
          return Data_Maybe.Just.create(Data_Function["const"](new RouteTo(Polaris_UI_Data_Route.Catalog.value))($20));
      }) ])([ Halogen_HTML_Core.text("Catalog") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function ($21) {
          return Data_Maybe.Just.create(Data_Function["const"](new RouteTo(Polaris_UI_Data_Route.Config.value))($21));
      }) ])([ Halogen_HTML_Core.text("Config") ]) ]), (function () {
          if (v.route instanceof Polaris_UI_Data_Route.Home) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "home";
              }))(Data_Ord.ordUnit)(_home)(Data_Unit.unit)(Polaris_UI_Page_Home.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value));
          };
          if (v.route instanceof Polaris_UI_Data_Route.Company) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "company";
              }))(Data_Ord.ordUnit)(_company)(Data_Unit.unit)(Polaris_UI_Page_Company.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value));
          };
          if (v.route instanceof Polaris_UI_Data_Route.Catalog) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "catalog";
              }))(Data_Ord.ordUnit)(_catalog)(Data_Unit.unit)(Polaris_UI_Page_Catalog.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value));
          };
          if (v.route instanceof Polaris_UI_Data_Route.Config) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "config";
              }))(Data_Ord.ordUnit)(_config)(Data_Unit.unit)(Polaris_UI_Page_Config.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value));
          };
          throw new Error("Failed pattern match at Polaris.UI.Router (line 78, column 5 - line 82, column 76): " + [ v.route.constructor.name ]);
      })() ]);
  };
  var component = function (dictNavigate) {
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              handleAction: handleAction(dictNavigate),
...
(function($PS) {
  ...
  var Polaris_UI_AppM = $PS["Polaris.UI.AppM"];
  var Polaris_UI_Data_Route = $PS["Polaris.UI.Data.Route"];
  var Polaris_UI_Router = $PS["Polaris.UI.Router"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  var Routing_Hash = $PS["Routing.Hash"];                
  var main = (function () {
      var $4 = {
      ...
      return function __do() {
          ...
          var v1 = Data_Maybe.fromMaybe(Polaris_UI_Data_Route.Home.value)(Data_Either.hush(Routing_Duplex.parse(Polaris_UI_Data_Route.routeCodec)(v)));
          var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Polaris_UI_AppM.runAppM($4))(Polaris_UI_Router.component(Polaris_UI_AppM.navigateAppM));
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)(Data_Unit.unit)(v2))(function (v3) {
                  return Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Polaris_UI_Data_Route.routeCodec))(function (old) {
                      return function ($$new) {
                          return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Polaris_UI_Data_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(v3.query(Halogen_Query.tell(Polaris_UI_Router.Navigate.create($$new)))));
                      };
                  })));
              });
          }))();
