...
(function(exports) {
  ...
  var slide = function (size) {
      return function (xs) {
          return function (x) {
              ...
              if ((Data_Array.length(xs) + 1 | 0) <= size) {
                  return Data_Maybe.Just.create(Data_Array.snoc(xs)(x));
              };
              if (Data_Array.length(xs) === size) {
                  return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.flap(Data_Functor.functorFn)(Data_Array.snoc)(x))(Data_Array.tail(xs));
              };
              if (Data_Boolean.otherwise) {
                  return Data_Maybe.Nothing.value;
              };
              throw new Error("Failed pattern match at ABBABA line 87, column 1 - line 87, column 58: " + [ size.constructor.name, xs.constructor.name, x.constructor.name ]);
          };
      };
  };
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "success";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showBoolean))(Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showChar)(Data_Time_Duration.showMilliseconds)))))({
          buffer: v.buffer,
          success: v.success
          ...
          if (v1 instanceof Data_Maybe.Just && (v1.value0 === "A" || v1.value0 === "B")) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                      var newBuffer = Data_Maybe.fromMaybe(v3.buffer)(slide(v3.size)(v3.buffer)(new Data_Tuple.Tuple(v1.value0, v2)));
                      ...
                      })(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(Data_Array.head(newBuffer))))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(Data_Array.last(newBuffer))));
                      var $21 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqChar))(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(newBuffer))(v3.secret) && withinDuration;
                      if ($21) {
