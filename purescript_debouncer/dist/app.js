...
(function(exports) {
  ...
  var Data_Semiring = PS["Data.Semiring"];
  var Prelude = PS["Prelude"];
  var putRight = function (x) {
      return function (v) {
          return {
              buffer: Data_Array.drop((Data_Array.length(v.buffer) + 1 | 0) - v.size | 0)(Data_Functor.flap(Data_Functor.functorFn)(Data_Array.snoc)(x)(v.buffer)),
              size: v.size
          };
      };
  };
  var last = function (v) {
      return Data_Array.last(v.buffer);
  };
  var head = function (v) {
      return Data_Array.head(v.buffer);
  };

  // TODO size >= 1
  // | Getters
  var getBuffer = function (v) {
      return v.buffer;
  };
  ...
  exports["last"] = last;
  exports["empty"] = empty;
})(PS["SlidingBuffer"] = PS["SlidingBuffer"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Apply = PS["Control.Apply"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SlidingBuffer = PS["SlidingBuffer"];
  var Web_Event_Event = PS["Web.Event.Event"];
  var Web_UIEvent_KeyboardEvent = PS["Web.UIEvent.KeyboardEvent"];                 
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "size";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showChar)(Data_Time_Duration.showMilliseconds)))))))({
          buffer: v.buffer,
          success: v.success
      })) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(OnKeyDown.create)) ]) ]);
  };
  var initialState = {
      buffer: SlidingBuffer.fromArray([  ])(6),
      secret: Data_String_CodeUnits.toCharArray("ABBABA"),
      maxDuration: 3000.0,
      success: false
  };
  var $$eval = function (v) {
      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
          var v1 = Data_String_CodeUnits.toChar(Data_String_Common.toUpper(Web_UIEvent_KeyboardEvent.key(v.value0)));
          if (v1 instanceof Data_Maybe.Just && (v1.value0 === "A" || v1.value0 === "B")) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                      var newBuffer = SlidingBuffer.putRight(new Data_Tuple.Tuple(v1.value0, v2))(v3.buffer);
                      var withinDuration = Data_Maybe.fromMaybe(false)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v4) {
                          return function (v5) {
                              return Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(v4 - v5) < v3.maxDuration;
                          };
                      })(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(SlidingBuffer.head(newBuffer))))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(SlidingBuffer.last(newBuffer))));
                      var $18 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqChar))(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(SlidingBuffer.getBuffer(newBuffer)))(v3.secret) && withinDuration;
                      if ($18) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              var $19 = {};
                              for (var $20 in v4) {
                                  if ({}.hasOwnProperty.call(v4, $20)) {
                                      $19[$20] = v4[$20];
                                  };
                              };
                              $19.buffer = SlidingBuffer.empty(newBuffer);
                              $19.success = true;
                              return $19;
                          });
                      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          return Halogen_VDom_Driver.runUI(ABBABA.component)(Data_Unit.unit)(Data_Maybe.fromMaybe(v)(v1));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
