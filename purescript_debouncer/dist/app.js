...
(function(exports) {
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          search: v.search
      })) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Search.create)), Halogen_HTML_Properties.value(v.search) ]) ]);
  };
  var initialState = {
      search: "",
  ...
  var $$eval = function (v) {
      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              ...
              $19.inputText = v.value0;
              return $19;
          }))(function () {
              if (v1.debouncer instanceof Data_Maybe.Nothing) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff_AVar.empty))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(v1.debounceTime))(function () {
                          return Effect_Aff_AVar.put(Data_Unit.unit)(v2);
                      }))))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Effect_Aff_Class.monadAffAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff_AVar.take(v2)))(function (v4) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  ...
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v6) {
                                      var $26 = {};
                                      for (var $27 in v6) {
                                          if ({}.hasOwnProperty.call(v6, $27)) {
                                              $26[$27] = v6[$27];
                                          };
                                      };
              ...
              if (v1.debouncer instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.killFiber(Effect_Exception.error("renew timer"))(v1.debouncer.value0.fiber)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(v1.debounceTime))(function () {
                          return Effect_Aff_AVar.put(Data_Unit.unit)(v1.debouncer.value0.channel);
                      }))))(function (v3) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              $33.debouncer = new Data_Maybe.Just({
                                  channel: v1.debouncer.value0.channel,
                                  fiber: v3
                              });
                              return $33;
                          });
              ...
              throw new Error("Failed pattern match at Search line 56, column 3 - line 72, column 69: " + [ v1.debouncer.constructor.name ]);
          });
      }));
  };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          return Halogen_VDom_Driver.runUI(Search.component)(Data_Unit.unit)(Data_Maybe.fromMaybe(v)(v1));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
