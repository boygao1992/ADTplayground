          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $50.mouse = new Data_Maybe.Just(event.value0);
                      return $50;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $54.mouse = Data_Maybe.Nothing.value;
                      return $54;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $57.mouse = new Data_Maybe.Just(event.value0);
                      return $57;
                  })(new Data_Maybe.Just(new Select(event.value0)));
              };
              throw new Error("Failed pattern match at Select line 222, column 3 - line 228, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $67.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $67;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $72.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $72;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $75.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $75.head = v1.head - 1 | 0;
                              return $75;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $78.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $78;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 127, column 9 - line 135, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 117, column 5 - line 135, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $83.key = new Data_Maybe.Just(v1.head);
                          return $83;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $88.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $88;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $91.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $91.head = v1.head + 1 | 0;
                              return $91;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $94.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $94;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 148, column 9 - line 156, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 138, column 5 - line 156, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 115, column 3 - line 156, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Select line 90, column 38 - line 98, column 32: " + [ event.constructor.name ]);
          };
      };
  };
      ...
      return function (v) {
          if (v instanceof Sync) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $106.external = Data_Maybe.Just.create(Data_Foldable.foldl(dictFoldable)(function (acc) {
                      return function (x) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $119.internal = v3.value0(st.internal);
                          return $119;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Select line 320, column 3 - line 322, column 25: " + [ v3.value1.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $132.internal = v4.value0(st.internal);
                                  return $132;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 336, column 7 - line 338, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $142.internal = v4.value0(st.internal);
                                  return $142;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v4.value1 instanceof Data_Maybe.Just) {
                                      ...
                                      throw new Error("Failed pattern match at Select line 346, column 7 - line 348, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
          ...
          throw new Error("Failed pattern match at Select line 298, column 1 - line 298, column 106: " + [ v.constructor.name ]);
      };
  };
  var defaultConfig = {
      windowSize: 5,
      ...
      return function (v) {
          ...
          var toUl = function (e) {
              var v1 = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Select line 236, column 1 - line 236, column 95: " + [ e.constructor.name ]);
              };
              if (e instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("autocomplete-list"), Halogen_HTML_CSS.style(CSS_Geometry.maxHeight(CSS_Size.px(Data_Int.toNumber(30 * v.config.windowSize | 0)))) ])(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (index) {
                      return function (acc) {
                          return function (item) {
