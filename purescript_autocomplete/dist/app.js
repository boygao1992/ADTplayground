...
(function(exports) {
  ...
  var searchTransition = function (v) {
      return function (event) {
          return function (v1) {
              var candidates = Data_Array.take(v.listSize)(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(Data_Array.filter(function ($332) {
                  return Data_String_CodeUnits.contains(event.value0)(Data_Tuple.snd($332));
              })(event.value1)));
          ...
          return function (v1) {
              if (event instanceof KeyUp) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var $133 = outsideWindow(v1.key.value0)(v1.head);
                      if ($133) {
                          var selection = new Data_Maybe.Just((Data_Int.floor(v1.head) + v.windowSize | 0) - 1 | 0);
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v2) {
                      ...
                      if (!v3 && v2) {
                          ...
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v4) {
                                  ...
                                  $145.key = selection;
                                  $145.head = Data_Int.toNumber(v1.key.value0 - 1 | 0);
                                  return $145;
              ...
              if (event instanceof KeyDown) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var $170 = outsideWindow(v1.key.value0)(v1.head);
                      if ($170) {
                          var selection = Data_Maybe.Just.create(Data_Int.floor(v1.head));
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v2) {
                      ...
                      if (!v3 && v2) {
                          ...
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v4) {
                                  var $182 = {};
                                  for (var $183 in v4) {
                                      if ({}.hasOwnProperty.call(v4, $183)) {
                                          $182[$183] = v4[$183];
                                      };
                                  };
                                  $182.key = selection;
                                  $182.head = Data_Int.toNumber((v1.key.value0 + 2 | 0) - v.windowSize | 0);
                                  return $182;
                              })(new Data_Maybe.Just(WindowSlideDown.value));
                          };
                          if (v1.mouse instanceof Data_Maybe.Nothing) {
      ...
      return function (v1) {
              ...
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v1.internal.selection)(function (v3) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(v1.internal.candidates)(function (v4) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v4)(v3))(function (v5) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.find(Data_Foldable.foldableArray)(function ($333) {
                              return (function (v6) {
                                  return v6 === v5;
                              })(v.toId($333));
                          })(v2))(function (v6) {
          ...
          var candidateList = (function () {
              ...
              if (v1.internal.candidates instanceof Data_Maybe.Just) {
                  ...
                  return Data_Array.filter(function ($334) {
                      return Data_Functor.flap(Data_Functor.functorFn)(Data_Set.member(Data_Ord.ordString))(idSet)(v.toId($334));
                  })(xs);
              };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $229.internal = (function () {
                          var $226 = {};
                          for (var $227 in st.internal) {
                              if ({}.hasOwnProperty.call(st.internal, $227)) {
                                  $226[$227] = st["internal"][$227];
                              };
                          };
                          $226.key = Data_Maybe.Nothing.value;
                          $226.mouse = Data_Maybe.Nothing.value;
                          $226.head = 0.0;
                          $226.selection = Data_Maybe.Nothing.value;
                          return $226;
                      })();
                      $229.external = Data_Maybe.Just.create(v1.value0);
                      return $229;
                  }))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $233.internal = v3.value0(st.internal);
                          return $233;
                      }))(function () {
          ...
          if (v1 instanceof StateTransition) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $252 = {};
                      for (var $253 in st) {
                          if ({}.hasOwnProperty.call(st, $253)) {
                              $252[$253] = st[$253];
                          };
                      };
                      $252.internal = v3.value0(st.internal);
                      return $252;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $267.internal = v5.value0(st.internal);
                                  return $267;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $287.internal = v5.value0(st.internal);
                                  return $287;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
          ...
          if (v1 instanceof OnInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $314.internal = v3.value0(st.internal);
                      return $314;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $320 = {};
                          for (var $321 in st) {
                              if ({}.hasOwnProperty.call(st, $321)) {
                                  $320[$321] = st[$321];
                              };
                          };
                          $320.internal = (function () {
                              var $317 = {};
                              for (var $318 in st.internal) {
                                  if ({}.hasOwnProperty.call(st.internal, $318)) {
                                      $317[$318] = st["internal"][$318];
                                  };
                              };
                              $317.key = Data_Maybe.Nothing.value;
                              $317.selection = Data_Maybe.Nothing.value;
                              return $317;
                          })();
                          return $320;
                      }))(function () {
