...
(function(exports) {
  ...
  var searchTransition = function (v) {
      return function (event) {
          return function (v1) {
              var candidates = Data_Array.take(v.listSize)(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(Data_Array.filter(function ($336) {
                  return Data_String_CodeUnits.contains(event.value0)(Data_Tuple.snd($336));
              })(event.value1)));
              return Utils.withCmds(function (v2) {
                  ...
                  $86.search = event.value0;
                  $86.candidates = new Data_Maybe.Just(candidates);
                  return $86;
              })(Data_Maybe.Nothing.value);
          };
      };
          ...
          return function (v1) {
              ...
              if (event instanceof MouseLeave) {
                  return Utils.withCmds(function (v2) {
                      ...
                      $111.mouse = Data_Maybe.Nothing.value;
                      $111.selection = v1.key;
                      return $111;
                  })(Data_Maybe.Nothing.value);
              };
              ...
              throw new Error("Failed pattern match at Select line 368, column 3 - line 380, column 82: " + [ event.constructor.name ]);
          };
      };
  };
  var keyboardTransition = function (config) {
      return function (event) {
          return function (v) {
              if (v.candidates instanceof Data_Maybe.Nothing) {
                  return Utils.withCmds(function (v1) {
                      var $124 = {};
                      for (var $125 in v1) {
                      ...
                      $124.key = Data_Maybe.Nothing.value;
                      $124.selection = Data_Maybe.Nothing.value;
                      return $124;
                  })(Data_Maybe.Nothing.value);
              };
              if (v.candidates instanceof Data_Maybe.Just) {
                  var listSize = Data_Array.length(v.candidates.value0);
                  var windowSize = Data_Ord.min(Data_Ord.ordInt)(config.windowSize)(listSize);
                  if (event instanceof KeyUp) {
                      if (v.key instanceof Data_Maybe.Nothing) {
                          var selection = new Data_Maybe.Just((Data_Int.floor(v.head) + windowSize | 0) - 1 | 0);
                          if (v.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v1) {
                                  var $130 = {};
                                  for (var $131 in v1) {
                          ...
                          if (v.mouse instanceof Data_Maybe.Nothing) {
                              return Utils.withCmds(function (v1) {
                                  var $134 = {};
                                  for (var $135 in v1) {
                          ...
                          throw new Error("Failed pattern match at Select line 181, column 9 - line 185, column 83: " + [ v.mouse.constructor.name ]);
                      };
                      if (v.key instanceof Data_Maybe.Just) {
                          var windowAtUpperBoundary = function (h) {
                              return h <= 0;
                          };
                          var outsideWindow = function (k) {
                              return function (h) {
                                  return (k - Data_Int.floor(h) | 0) < 0 || (k - Data_Int.ceil(h) | 0) > windowSize;
                              };
                          };
                          var belowWindow = function (k) {
                              return function (h) {
                                  return (k - Data_Int.floor(h) | 0) >= windowSize;
                              };
                          };
                          ...
                          var $137 = outsideWindow(v.key.value0)(v.head);
                          if ($137) {
                              var selection = new Data_Maybe.Just((Data_Int.floor(v.head) + windowSize | 0) - 1 | 0);
                              if (v.mouse instanceof Data_Maybe.Just) {
                                  return Utils.withCmds(function (v1) {
                              ...
                              throw new Error("Failed pattern match at Select line 202, column 15 - line 206, column 89: " + [ v.mouse.constructor.name ]);
                          };
                          var v1 = aboveWindow(v.key.value0 - 1 | 0)(v.head);
                          var v2 = windowAtUpperBoundary(Data_Int.floor(v.head));
                          if (v2 && v1) {
                          ...
                          if (!v2 && v1) {
                              var selection = Data_Maybe.Just.create(v.key.value0 - 1 | 0);
                              if (v.mouse instanceof Data_Maybe.Just) {
                                  return Utils.withCmds(function (v3) {
                                      var $149 = {};
                                      for (var $150 in v3) {
                                          if ({}.hasOwnProperty.call(v3, $150)) {
                                              $149[$150] = v3[$150];
                                          };
                                      };
                                      $149.key = selection;
                                      $149.head = Data_Int.toNumber(v.key.value0 - 1 | 0);
                                      return $149;
                              ...
                              if (v.mouse instanceof Data_Maybe.Nothing) {
                                  return Utils.withCmds(function (v3) {
                                      ...
                                      $153.key = selection;
                                      $153.head = Data_Int.toNumber(v.key.value0 - 1 | 0);
                                      $153.selection = selection;
                                      return $153;
                                  })(new Data_Maybe.Just(WindowSlideUp.value));
                              };
                              throw new Error("Failed pattern match at Select line 215, column 17 - line 219, column 118: " + [ v.mouse.constructor.name ]);
                          };
                          var selection = Data_Maybe.Just.create(v.key.value0 - 1 | 0);
                          if (v.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v3) {
                          ...
                          throw new Error("Failed pattern match at Select line 224, column 17 - line 228, column 76: " + [ v.mouse.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Select line 176, column 7 - line 228, column 76: " + [ v.key.constructor.name ]);
                  };
                  if (event instanceof KeyDown) {
                      if (v.key instanceof Data_Maybe.Nothing) {
                          var selection = Data_Maybe.Just.create(Data_Int.floor(v.head));
                          if (v.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v1) {
                                  var $167 = {};
                                  for (var $168 in v1) {
                          ...
                          throw new Error("Failed pattern match at Select line 236, column 11 - line 240, column 82: " + [ v.mouse.constructor.name ]);
                      };
                      if (v.key instanceof Data_Maybe.Just) {
                          var windowAtLowerBoundary = function (h) {
                              return h >= (listSize - windowSize | 0);
                          };
                          var outsideWindow = function (k) {
                              return function (h) {
                                  return (k - Data_Int.floor(h) | 0) < 0 || (k - Data_Int.ceil(h) | 0) > windowSize;
                          ...
                          var $174 = outsideWindow(v.key.value0)(v.head);
                          if ($174) {
                              var selection = Data_Maybe.Just.create(Data_Int.floor(v.head));
                              if (v.mouse instanceof Data_Maybe.Just) {
                                  return Utils.withCmds(function (v1) {
                              ...
                              throw new Error("Failed pattern match at Select line 257, column 15 - line 261, column 86: " + [ v.mouse.constructor.name ]);
                          };
                          var v1 = belowWindow(v.key.value0 + 1 | 0)(v.head);
                          var v2 = windowAtLowerBoundary(Data_Int.floor(v.head));
                          if (v2 && v1) {
                          ...
                          if (!v2 && v1) {
                              ...
                              if (v.mouse instanceof Data_Maybe.Just) {
                                  return Utils.withCmds(function (v3) {
                                      var $186 = {};
                                      for (var $187 in v3) {
                                          if ({}.hasOwnProperty.call(v3, $187)) {
                                              $186[$187] = v3[$187];
                                          };
                                      };
                                      $186.key = selection;
                                      $186.head = Data_Int.toNumber((v.key.value0 + 2 | 0) - windowSize | 0);
                                      return $186;
                                  })(new Data_Maybe.Just(WindowSlideDown.value));
                              };
                              if (v.mouse instanceof Data_Maybe.Nothing) {
                                  return Utils.withCmds(function (v3) {
                                      var $190 = {};
                                      for (var $191 in v3) {
                                          if ({}.hasOwnProperty.call(v3, $191)) {
                                              $190[$191] = v3[$191];
                                          };
                                      };
                                      $190.key = selection;
                                      $190.head = Data_Int.toNumber((v.key.value0 + 2 | 0) - windowSize | 0);
                                      $190.selection = selection;
                                      return $190;
                                  })(new Data_Maybe.Just(WindowSlideDown.value));
                              };
                              throw new Error("Failed pattern match at Select line 270, column 17 - line 274, column 133: " + [ v.mouse.constructor.name ]);
                          };
                          var selection = Data_Maybe.Just.create(v.key.value0 + 1 | 0);
                          if (v.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v3) {
                          ...
                          throw new Error("Failed pattern match at Select line 279, column 17 - line 283, column 77: " + [ v.mouse.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Select line 231, column 7 - line 283, column 77: " + [ v.key.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 174, column 8 - line 283, column 77: " + [ event.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 167, column 3 - line 283, column 77: " + [ v.candidates.constructor.name ]);
          };
      };
  };
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Select line 115, column 38 - line 125, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  var defaultConfig = {
  ...
  var buildRender = function (v) {
      return function (v1) {
          ...
          var inputValue = Data_Maybe.fromMaybe(v1.internal.search)(Control_Bind.bind(Data_Maybe.bindMaybe)(v1.external)(function (v2) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v1.internal.selection)(function (v3) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(v1.internal.candidates)(function (v4) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v4)(v3))(function (v5) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.find(Data_Foldable.foldableArray)(function ($337) {
                              return (function (v6) {
                                  return v6 === v5;
                              })(v.toId($337));
                          })(v2))(function (v6) {
                              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.toKeyword(v6));
                          });
                      });
                  });
              });
          ...
          var candidateList = (function () {
              var xs = Data_Maybe.fromMaybe([  ])(v1.external);
              if (v1.internal.candidates instanceof Data_Maybe.Just) {
                  var idSet = Data_Set.fromFoldable(Data_Foldable.foldableArray)(Data_Ord.ordString)(v1.internal.candidates.value0);
                  return Data_Array.filter(function ($338) {
                      return Data_Functor.flap(Data_Functor.functorFn)(Data_Set.member(Data_Ord.ordString))(idSet)(v.toId($338));
                  })(xs);
              };
              if (v1.internal.candidates instanceof Data_Maybe.Nothing) {
                  return xs;
              };
              throw new Error("Failed pattern match at Select line 421, column 9 - line 428, column 15: " + [ v1.internal.candidates.constructor.name ]);
          })();
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("example-autocomplete") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(OnKeyDown.create)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(OnInput.create)), Halogen_HTML_Properties.class_("autocomplete-input"), Halogen_HTML_Properties.value(inputValue), Halogen_HTML_Properties.ref(inputRef) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("autocomplete-menu") ])([ toUl(candidateList) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "selection";
          }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Show.showString))(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Show.showNumber))(Data_Maybe.showMaybe(Data_Show.showArray(Data_Show.showString)))))(v1.internal)) ]) ]);
      };
  };
      ...
      var $$eval = function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $233.internal = (function () {
                          var $230 = {};
                          for (var $231 in st.internal) {
                              if ({}.hasOwnProperty.call(st.internal, $231)) {
                                  $230[$231] = st["internal"][$231];
                              };
                          };
                          $230.key = Data_Maybe.Nothing.value;
                          $230.mouse = Data_Maybe.Nothing.value;
                          $230.head = 0.0;
                          $230.selection = Data_Maybe.Nothing.value;
                          return $230;
                      })();
                      $233.external = Data_Maybe.Just.create(v1.value0);
                      return $233;
                  }))(function () {
                      var v3 = stateTransition(v2.config)(new Search(new SearchInput(v2.internal.search, Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.fanout(Control_Category.categoryFn)(Data_Profunctor_Strong.strongFn)(v.toId)(v.toKeyword))(v1.value0))))(v2.internal);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $237 = {};
                          for (var $238 in st) {
                          ...
                          $237.internal = v3.value0(st.internal);
                          return $237;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  if (v4 instanceof Data_Maybe.Just) {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop(0.0)(Web_HTML_HTMLElement.toElement(v4.value0)));
                                  };
          ...
          if (v1 instanceof Configure) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $249.config = v1.value0;
                  return $249;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
              });
          };
          if (v1 instanceof StateTransition) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  var v3 = stateTransition(v2.config)(v1.value0)(v2.internal);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $256 = {};
                      for (var $257 in st) {
                      ...
                      $256.internal = v3.value0(st.internal);
                      return $256;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Select line 526, column 7 - line 528, column 29: " + [ v3.value1.constructor.name ]);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                      });
                  });
          ...
          if (v1 instanceof OnKeyDown) {
              var v2 = Web_UIEvent_KeyboardEvent.key(v1.value0);
              if (v2 === "ArrowUp") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v1.value0))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              var v5 = stateTransition(v3)(new Keyboard(KeyUp.value))(v4);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $271 = {};
                                  for (var $272 in st) {
                                  ...
                                  $271.internal = v5.value0(st.internal);
                                  return $271;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v5.value1 instanceof Data_Maybe.Just && v5.value1.value0 instanceof WindowSlideUp) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v6) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(keySelectedRef))(function (v7) {
                                                  if (v6 instanceof Data_Maybe.Just && v7 instanceof Data_Maybe.Just) {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetTop(v7.value0)))(function (v8) {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetHeight(v7.value0)))(function (v9) {
                                                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop(v8)(Web_HTML_HTMLElement.toElement(v6.value0)));
                                                          });
                                                      });
                                                  };
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          if (v5.value1 instanceof Data_Maybe.Just) {
                                              return Halogen_Query_HalogenM.raise(v5.value1.value0);
                                          };
                                          if (v5.value1 instanceof Data_Maybe.Nothing) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          };
                                          throw new Error("Failed pattern match at Select line 553, column 11 - line 555, column 33: " + [ v5.value1.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                                      });
                                  });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v1.value0))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              var v5 = stateTransition(v3)(new Keyboard(KeyDown.value))(v4);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $291 = {};
                                  for (var $292 in st) {
                                      if ({}.hasOwnProperty.call(st, $292)) {
                                          $291[$292] = st[$292];
                                      };
                                  };
                                  $291.internal = v5.value0(st.internal);
                                  return $291;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v5.value1 instanceof Data_Maybe.Just && v5.value1.value0 instanceof WindowSlideDown) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v6) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(keySelectedRef))(function (v7) {
                                                  if (v6 instanceof Data_Maybe.Just && v7 instanceof Data_Maybe.Just) {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetTop(v7.value0)))(function (v8) {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetHeight(v7.value0)))(function (v9) {
                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.clientHeight(Web_HTML_HTMLElement.toElement(v6.value0))))(function (v10) {
                                                                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop((v8 + v9) - v10)(Web_HTML_HTMLElement.toElement(v6.value0)));
                                                              });
                                                          });
                                                      });
                                                  };
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          throw new Error("Failed pattern match at Select line 579, column 11 - line 581, column 33: " + [ v5.value1.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                                      });
                                  });
          ...
          if (v1 instanceof OnScroll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v2) {
                  if (v2 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.scrollTop(Web_HTML_HTMLElement.toElement(v2.value0))))(function (v3) {
                          return $$eval(new StateTransition(Scroll.create(UpdateScrollPosition.create(v3 / Data_Int.toNumber(heightPx))), v1.value0));
                      });
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                  };
                  throw new Error("Failed pattern match at Select line 588, column 7 - line 592, column 29: " + [ v2.constructor.name ]);
              });
          };
          if (v1 instanceof OnInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  var v3 = stateTransition(v2.config)(new Search(new SearchInput(v1.value0, Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.fanout(Control_Category.categoryFn)(Data_Profunctor_Strong.strongFn)(v.toId)(v.toKeyword))(Data_Maybe.fromMaybe([  ])(v2.external)))))(v2.internal);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $318 = {};
                      for (var $319 in st) {
                      ...
                      $318.internal = v3.value0(st.internal);
                      return $318;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $324 = {};
                          for (var $325 in st) {
                              if ({}.hasOwnProperty.call(st, $325)) {
                                  $324[$325] = st[$325];
                              };
                          };
                          $324.internal = (function () {
                              var $321 = {};
                              for (var $322 in st.internal) {
                                  if ({}.hasOwnProperty.call(st.internal, $322)) {
                                      $321[$322] = st["internal"][$322];
                                  };
                              };
                              $321.key = Data_Maybe.Nothing.value;
                              $321.selection = Data_Maybe.Nothing.value;
                              return $321;
                          })();
                          return $324;
                      }))(function () {
          ...
          throw new Error("Failed pattern match at Select line 491, column 5 - line 491, column 77: " + [ v1.constructor.name ]);
      };
      return $$eval;
  };
  var buildComponent = function (dataConfig) {
