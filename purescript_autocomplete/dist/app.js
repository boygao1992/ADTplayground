...
(function(exports) {
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $59.mouse = new Data_Maybe.Just(event.value0);
                      return $59;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $63.mouse = Data_Maybe.Nothing.value;
                      return $63;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $66.mouse = new Data_Maybe.Just(event.value0);
                      return $66;
                  })(new Data_Maybe.Just(new Select(event.value0)));
              };
              throw new Error("Failed pattern match at Select line 223, column 3 - line 229, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $76.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $76;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var v3 = windowAtUpperBoundary(v1.head);
                      if (v3 && v2) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $81.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $81;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $84.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $84.head = v1.head - 1 | 0;
                              return $84;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $87.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $87;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 128, column 9 - line 136, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 118, column 5 - line 136, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $92.key = new Data_Maybe.Just(v1.head);
                          return $92;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var belowWindow = function (k) {
                          return function (h) {
                              return (k - h | 0) >= v.windowSize;
                          };
                      };
                      var v2 = belowWindow(v1.key.value0 + 1 | 0)(v1.head);
                      var v3 = windowAtLowerBoundary(v1.head);
                      if (v3 && v2) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $97.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $97;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $100.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $100.head = v1.head + 1 | 0;
                              return $100;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $103.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $103;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 149, column 9 - line 157, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 139, column 5 - line 157, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 116, column 3 - line 157, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Select line 91, column 38 - line 99, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var $$eval = function (v) {
      if (v instanceof Sync) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $116.internal = empty;
                  $116.external = Data_Maybe.Just.create(Data_Array.take(v1)(v.value0));
                  return $116;
              }))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $132.internal = v3.value0(st.internal);
                      return $132;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Select line 336, column 3 - line 338, column 25: " + [ v3.value1.constructor.name ]);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $145.internal = v4.value0(st.internal);
                              return $145;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 365, column 7 - line 367, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $165.internal = v4.value0(st.internal);
                              return $165;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 391, column 7 - line 393, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
      ...
      throw new Error("Failed pattern match at Select line 305, column 1 - line 305, column 86: " + [ v.constructor.name ]);
  };
  var defaultConfig = {
      windowSize: 5,
      listSize: 10
  ...
  var buildRender = function (li) {
      return function (v) {
          ...
          var toUl = function (v1) {
              if (v1 instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("autocomplete-list"), Halogen_HTML_CSS.style(CSS_Geometry.maxHeight(CSS_Size.px(Data_Int.toNumber(30 * v.config.windowSize | 0)))), Halogen_HTML_Properties.ref(ulRef) ])(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (index) {
                      return function (acc) {
                          return function (item) {
