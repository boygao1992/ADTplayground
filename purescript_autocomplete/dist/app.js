...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];                 
  var withCmds = function (model) {
      return function (cmd) {
          return new Data_Tuple.Tuple(model, cmd);
      };
  };
  var classList = function ($0) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(function ($1) {
          return Halogen_HTML_Core.ClassName(Data_Tuple.fst($1));
      })(Data_Array.filter(Data_Tuple.snd)($0)));
  };
...
(function(exports) {
  ...
  var SearchInput = (function () {
      function SearchInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SearchInput.create = function (value0) {
          return function (value1) {
              return new SearchInput(value0, value1);
          };
      };
      return SearchInput;
  })();
  var UpdateScrollPosition = (function () {
      function UpdateScrollPosition(value0) {
          this.value0 = value0;
      };
      UpdateScrollPosition.create = function (value0) {
          return new UpdateScrollPosition(value0);
      };
      return UpdateScrollPosition;
  })();
  var WindowPushUpperBoundary = (function () {
      function WindowPushUpperBoundary() {

      };
      WindowPushUpperBoundary.value = new WindowPushUpperBoundary();
      return WindowPushUpperBoundary;
  })();
  var WindowPushLowerBoundary = (function () {
      function WindowPushLowerBoundary() {

      };
      WindowPushLowerBoundary.value = new WindowPushLowerBoundary();
      return WindowPushLowerBoundary;
  })();
  var WindowSlideUp = (function () {
      function WindowSlideUp() {

      };
      WindowSlideUp.value = new WindowSlideUp();
      return WindowSlideUp;
  })();
  var WindowSlideDown = (function () {
      function WindowSlideDown() {

      };
      WindowSlideDown.value = new WindowSlideDown();
      return WindowSlideDown;
  })();
  var Select = (function () {
  ...
  var StateTransition = (function () {
      function StateTransition(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      StateTransition.create = function (value0) {
          return function (value1) {
              return new StateTransition(value0, value1);
          };
      };
  ...
  var Configure = (function () {
      ...
      Configure.create = function (value0) {
          return function (value1) {
              return new Configure(value0, value1);
          };
      };
      return Configure;
  })();
  ...
  var searchTransition = function (v) {
      return function (event) {
          return function (v1) {
              var candidates = Data_Set.fromFoldable(Data_Foldable.foldableArray)(Data_Ord.ordInt)(Data_Array.take(v.listSize)(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.snd)(Data_Array.filter(Data_Tuple.fst)(Data_Array.mapWithIndex(function (idx) {
                  return function (str) {
                      return new Data_Tuple.Tuple(Data_String_CodeUnits.contains(event.value0)(str), idx);
                  };
              })(event.value1)))));
              return Utils.withCmds(function (v2) {
                  var $90 = {};
                  for (var $91 in v2) {
                  ...
                  $90.search = event.value0;
                  $90.candidates = new Data_Maybe.Just(candidates);
                  return $90;
              })(Data_Maybe.Nothing.value);
          };
      };
  };
  var scrollTransition = function (v) {
      return function (event) {
          return function (v1) {
              return Utils.withCmds(function (v2) {
                  var $100 = {};
                  ...
                  $100.head = event.value0;
                  return $100;
              })(Data_Maybe.Nothing.value);
          };
      };
  };
  var mouseTransition = function (v) {
      return function (event) {
          return function (v1) {
              if (event instanceof MouseEnter) {
                  var selection = new Data_Maybe.Just(event.value0);
                  return Utils.withCmds(function (v2) {
                      var $111 = {};
                      for (var $112 in v2) {
              ...
              if (event instanceof MouseLeave) {
                  return Utils.withCmds(function (v2) {
                      var $115 = {};
                      for (var $116 in v2) {
                      ...
                      $115.mouse = Data_Maybe.Nothing.value;
                      $115.selection = v1.key;
                      return $115;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  var selection = new Data_Maybe.Just(event.value0);
                  return Utils.withCmds(function (v2) {
                      var $118 = {};
                      for (var $119 in v2) {
              ...
              throw new Error("Failed pattern match at Select line 346, column 3 - line 358, column 82: " + [ event.constructor.name ]);
          };
      };
  };
  var keyboardTransition = function (v) {
      return function (event) {
          return function (v1) {
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      var selection = new Data_Maybe.Just((Data_Int.floor(v1.head) + v.windowSize | 0) - 1 | 0);
                      ...
                      if (v1.mouse instanceof Data_Maybe.Nothing) {
                          return Utils.withCmds(function (v2) {
                              var $134 = {};
                              for (var $135 in v2) {
                      ...
                      throw new Error("Failed pattern match at Select line 159, column 8 - line 163, column 82: " + [ v1.mouse.constructor.name ]);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      var windowAtUpperBoundary = function (h) {
                          return h <= 0;
                      };
                      var outsideWindow = function (k) {
                          return function (h) {
                              return (k - Data_Int.floor(h) | 0) < 0 || (k - Data_Int.ceil(h) | 0) > v.windowSize;
                          };
                      };
                      var belowWindow = function (k) {
                          return function (h) {
                              return (k - Data_Int.floor(h) | 0) >= v.windowSize;
                          };
                      };
                      var aboveWindow = function (k) {
                          return function (h) {
                              return (k - Data_Int.ceil(h) | 0) < 0;
                          };
                      };
                      var $137 = outsideWindow(v1.key.value0)(v1.head);
                      if ($137) {
                          var selection = new Data_Maybe.Just((Data_Int.floor(v1.head) + v.windowSize | 0) - 1 | 0);
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Select line 180, column 13 - line 184, column 87: " + [ v1.mouse.constructor.name ]);
                      };
                      var v2 = aboveWindow(v1.key.value0 - 1 | 0)(v1.head);
                      var v3 = windowAtUpperBoundary(Data_Int.floor(v1.head));
                      if (v3 && v2) {
                          return Utils.withCmds(Control_Category.identity(Control_Category.categoryFn))(new Data_Maybe.Just(WindowPushUpperBoundary.value));
                      };
                      if (!v3 && v2) {
                          var selection = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v4) {
                                  var $149 = {};
                                  for (var $150 in v4) {
                                  ...
                                  $149.key = selection;
                                  $149.head = Data_Int.toNumber(v1.key.value0 - 1 | 0);
                                  return $149;
                          ...
                          if (v1.mouse instanceof Data_Maybe.Nothing) {
                              return Utils.withCmds(function (v4) {
                                  ...
                                  $153.key = selection;
                                  $153.head = Data_Int.toNumber(v1.key.value0 - 1 | 0);
                                  $153.selection = selection;
                                  return $153;
                              })(new Data_Maybe.Just(WindowSlideUp.value));
                          };
                          throw new Error("Failed pattern match at Select line 193, column 15 - line 197, column 116: " + [ v1.mouse.constructor.name ]);
                      };
                      var selection = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                      if (v1.mouse instanceof Data_Maybe.Just) {
                          return Utils.withCmds(function (v4) {
                      ...
                      throw new Error("Failed pattern match at Select line 202, column 15 - line 206, column 74: " + [ v1.mouse.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 154, column 5 - line 206, column 74: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      var selection = Data_Maybe.Just.create(Data_Int.floor(v1.head));
                      if (v1.mouse instanceof Data_Maybe.Just) {
                          return Utils.withCmds(function (v2) {
                              var $167 = {};
                              for (var $168 in v2) {
                      ...
                      throw new Error("Failed pattern match at Select line 214, column 9 - line 218, column 80: " + [ v1.mouse.constructor.name ]);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      var windowAtLowerBoundary = function (h) {
                          return h >= (v.listSize - v.windowSize | 0);
                      };
                      var outsideWindow = function (k) {
                          return function (h) {
                              return (k - Data_Int.floor(h) | 0) < 0 || (k - Data_Int.ceil(h) | 0) > v.windowSize;
                      ...
                      var $174 = outsideWindow(v1.key.value0)(v1.head);
                      if ($174) {
                          var selection = Data_Maybe.Just.create(Data_Int.floor(v1.head));
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Select line 235, column 13 - line 239, column 84: " + [ v1.mouse.constructor.name ]);
                      };
                      var v2 = belowWindow(v1.key.value0 + 1 | 0)(v1.head);
                      var v3 = windowAtLowerBoundary(Data_Int.floor(v1.head));
                      if (v3 && v2) {
                          return Utils.withCmds(Control_Category.identity(Control_Category.categoryFn))(new Data_Maybe.Just(WindowPushLowerBoundary.value));
                      };
                      if (!v3 && v2) {
                          var selection = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                          if (v1.mouse instanceof Data_Maybe.Just) {
                              return Utils.withCmds(function (v4) {
                                  var $186 = {};
                                  for (var $187 in v4) {
                                      if ({}.hasOwnProperty.call(v4, $187)) {
                                          $186[$187] = v4[$187];
                                      };
                                  };
                                  $186.key = selection;
                                  $186.head = Data_Int.toNumber((v1.key.value0 + 2 | 0) - v.windowSize | 0);
                                  return $186;
                              })(new Data_Maybe.Just(WindowSlideDown.value));
                          };
                          if (v1.mouse instanceof Data_Maybe.Nothing) {
                              return Utils.withCmds(function (v4) {
                                  var $190 = {};
                                  for (var $191 in v4) {
                                      if ({}.hasOwnProperty.call(v4, $191)) {
                                          $190[$191] = v4[$191];
                                      };
                                  };
                                  $190.key = selection;
                                  $190.head = Data_Int.toNumber((v1.key.value0 + 2 | 0) - v.windowSize | 0);
                                  $190.selection = selection;
                                  return $190;
                              })(new Data_Maybe.Just(WindowSlideDown.value));
                          };
                          throw new Error("Failed pattern match at Select line 248, column 15 - line 252, column 131: " + [ v1.mouse.constructor.name ]);
                      };
                      var selection = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                      if (v1.mouse instanceof Data_Maybe.Just) {
                          return Utils.withCmds(function (v4) {
                      ...
                      throw new Error("Failed pattern match at Select line 257, column 15 - line 261, column 75: " + [ v1.mouse.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 209, column 5 - line 261, column 75: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 152, column 3 - line 261, column 75: " + [ event.constructor.name ]);
          };
      };
  };
  var keySelectedRef = "keySelected";
  var inputRef = "autocomplete-input";
  var heightPx = 30;
  var empty = {
      ...
      search: "",
      candidates: Data_Maybe.Nothing.value
  };
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              if (event instanceof Keyboard) {
                  return keyboardTransition(config)(event.value0)(state);
              };
              if (event instanceof Scroll) {
                  return scrollTransition(config)(event.value0)(state);
              };
              if (event instanceof Mouse) {
                  return mouseTransition(config)(event.value0)(state);
              };
              if (event instanceof Search) {
                  return searchTransition(config)(event.value0)(state);
              };
              if (event instanceof Reset) {
                  return new Data_Tuple.Tuple(Data_Function["const"](empty), Data_Maybe.Nothing.value);
              };
              throw new Error("Failed pattern match at Select line 98, column 38 - line 108, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  var $$eval = function (dictShow) {
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $217.internal = (function () {
                          var $214 = {};
                          for (var $215 in st.internal) {
                              if ({}.hasOwnProperty.call(st.internal, $215)) {
                                  $214[$215] = st["internal"][$215];
                              };
                          };
                          $214.key = Data_Maybe.Nothing.value;
                          $214.mouse = Data_Maybe.Nothing.value;
                          $214.head = 0.0;
                          $214.selection = Data_Maybe.Nothing.value;
                          return $214;
                      })();
                      $217.external = Data_Maybe.Just.create(v.value0);
                      return $217;
                  }))(function () {
                      var v2 = stateTransition(v1.config)(new Search(new SearchInput(v1.internal.search, Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(dictShow))(v.value0))))(v1.internal);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $221 = {};
                          for (var $222 in st) {
                          ...
                          $221.internal = v2.value0(st.internal);
                          return $221;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  if (v3 instanceof Data_Maybe.Just) {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop(0.0)(Web_HTML_HTMLElement.toElement(v3.value0)));
                                  };
          ...
          if (v instanceof StateTransition) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var v2 = stateTransition(v1.config)(v.value0)(v1.internal);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $240 = {};
                      for (var $241 in st) {
                      ...
                      $240.internal = v2.value0(st.internal);
                      return $240;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2.value1 instanceof Data_Maybe.Just) {
                              return Halogen_Query_HalogenM.raise(v2.value1.value0);
                          };
                          if (v2.value1 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at Select line 501, column 3 - line 503, column 25: " + [ v2.value1.constructor.name ]);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
          ...
          if (v instanceof OnKeyDown) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              var v4 = stateTransition(v2)(new Keyboard(KeyUp.value))(v3);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $255 = {};
                                  for (var $256 in st) {
                                  ...
                                  $255.internal = v4.value0(st.internal);
                                  return $255;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v4.value1 instanceof Data_Maybe.Just && v4.value1.value0 instanceof WindowSlideUp) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v5) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(keySelectedRef))(function (v6) {
                                                  if (v5 instanceof Data_Maybe.Just && v6 instanceof Data_Maybe.Just) {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetTop(v6.value0)))(function (v7) {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetHeight(v6.value0)))(function (v8) {
                                                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop(v7)(Web_HTML_HTMLElement.toElement(v5.value0)));
                                                          });
                                                      });
                                                  };
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          if (v4.value1 instanceof Data_Maybe.Just) {
                                              return Halogen_Query_HalogenM.raise(v4.value1.value0);
                                          };
                                          if (v4.value1 instanceof Data_Maybe.Nothing) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          };
                                          throw new Error("Failed pattern match at Select line 530, column 7 - line 532, column 29: " + [ v4.value1.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                      });
                                  });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              var v4 = stateTransition(v2)(new Keyboard(KeyDown.value))(v3);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $275 = {};
                                  for (var $276 in st) {
                                      if ({}.hasOwnProperty.call(st, $276)) {
                                          $275[$276] = st[$276];
                                      };
                                  };
                                  $275.internal = v4.value0(st.internal);
                                  return $275;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v4.value1 instanceof Data_Maybe.Just && v4.value1.value0 instanceof WindowSlideDown) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v5) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(keySelectedRef))(function (v6) {
                                                  if (v5 instanceof Data_Maybe.Just && v6 instanceof Data_Maybe.Just) {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetTop(v6.value0)))(function (v7) {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetHeight(v6.value0)))(function (v8) {
                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.clientHeight(Web_HTML_HTMLElement.toElement(v5.value0))))(function (v9) {
                                                                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.setScrollTop((v7 + v8) - v9)(Web_HTML_HTMLElement.toElement(v5.value0)));
                                                              });
                                                          });
                                                      });
                                                  };
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          throw new Error("Failed pattern match at Select line 556, column 7 - line 558, column 29: " + [ v4.value1.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                      });
                                  });
              ...
              if (v1 === "Backspace") {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(inputRef))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2 instanceof Data_Maybe.Just) {
                              var v3 = Web_HTML_HTMLInputElement.fromHTMLElement(v2.value0);
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLInputElement.value(v3.value0)))(function (v4) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v5) {
                                          var v6 = stateTransition(v5.config)(new Search(new SearchInput(Data_String_CodePoints.take(Data_String_CodePoints.length(v4) - 1 | 0)(v4), Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(dictShow))(Data_Maybe.fromMaybe([  ])(v5.external)))))(v5.internal);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                              var $299 = {};
                                              for (var $300 in st) {
                                              ...
                                              $299.internal = v6.value0(st.internal);
                                              return $299;
                                          }))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          });
                              ...
                              throw new Error("Failed pattern match at Select line 565, column 11 - line 572, column 33: " + [ v3.constructor.name ]);
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at Select line 563, column 7 - line 573, column 29: " + [ v2.constructor.name ]);
                      })())(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  if (v3 instanceof Data_Maybe.Just) {
              ...
              var $312 = Data_String_CodePoints.length(v1) === 1;
              if ($312) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(inputRef))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2 instanceof Data_Maybe.Just) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLInputElement.value(v3.value0)))(function (v4) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v5) {
                                          var v6 = stateTransition(v5.config)(new Search(new SearchInput(v4 + v1, Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(dictShow))(Data_Maybe.fromMaybe([  ])(v5.external)))))(v5.internal);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                              var $319 = {};
                                              for (var $320 in st) {
                                              ...
                                              $319.internal = v6.value0(st.internal);
                                              return $319;
                                          }))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          });
                              ...
                              throw new Error("Failed pattern match at Select line 587, column 13 - line 594, column 35: " + [ v3.constructor.name ]);
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at Select line 585, column 9 - line 595, column 31: " + [ v2.constructor.name ]);
                      })())(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  if (v3 instanceof Data_Maybe.Just) {
          ...
          if (v instanceof OnScroll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.scrollTop(Web_HTML_HTMLElement.toElement(v1.value0))))(function (v2) {
                          return $$eval(dictShow)(new StateTransition(Scroll.create(UpdateScrollPosition.create(v2 / Data_Int.toNumber(heightPx))), v.value0));
                      });
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  };
                  throw new Error("Failed pattern match at Select line 614, column 3 - line 618, column 25: " + [ v1.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Select line 464, column 1 - line 464, column 99: " + [ v.constructor.name ]);
      };
  };
  var defaultConfig = {
      windowSize: 5,
  ...
  var buildRender = function (dictShow) {
      return function (li) {
          return function (v) {
              var toLi = function (index) {
                  return function (item) {
                      return Halogen_HTML_Elements.li(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Control_Bind.join(Control_Bind.bindArray)([ Data_Functor.voidLeft(Data_Functor.functorArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(index))(v.internal.key)))(Halogen_HTML_Properties.ref(keySelectedRef)) ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Utils.classList([ new Data_Tuple.Tuple("autocomplete-item", true), new Data_Tuple.Tuple("key-selected", Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(index))(v.internal.key)), new Data_Tuple.Tuple("mouse-selected", Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(index))(v.internal.mouse)) ]) ])([ Halogen_HTML_Events.onMouseEnter(Halogen_HTML_Events.input_(StateTransition.create(Mouse.create(new MouseEnter(index))))), Halogen_HTML_Events.onMouseLeave(Halogen_HTML_Events.input_(StateTransition.create(Mouse.create(MouseLeave.value)))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(StateTransition.create(Mouse.create(new MouseClick(index))))) ])))([ Halogen_HTML_Core.text(li(item)) ]);
                  };
              };
              var toUl = function (xs) {
                  return Halogen_HTML_Elements.ul([ Halogen_HTML_Events.onScroll(Halogen_HTML_Events.input_(OnScroll.create)), Halogen_HTML_Properties.class_("autocomplete-list"), Halogen_HTML_CSS.style(CSS_Geometry.maxHeight(CSS_Size.px(Data_Int.toNumber(heightPx * v.config.windowSize | 0)))), Halogen_HTML_Properties.ref(ulRef) ])(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (index) {
                      return function (acc) {
                          return function (item) {
                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc)([ toLi(index)(item) ]);
                          };
                      };
                  })([  ])(xs));
              };
              var inputValue = (function () {
                  if (v.external instanceof Data_Maybe.Just) {
                      if (v.internal.selection instanceof Data_Maybe.Just) {
                          return Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Show.show(dictShow))(Data_Array.index(v.external.value0)(v.internal.selection.value0)));
                      };
                      if (v.internal.selection instanceof Data_Maybe.Nothing) {
                          return "";
                      };
                      throw new Error("Failed pattern match at Select line 411, column 11 - line 416, column 9: " + [ v.internal.selection.constructor.name ]);
                  };
                  if (v.external instanceof Data_Maybe.Nothing) {
                      return "";
                  };
                  throw new Error("Failed pattern match at Select line 409, column 7 - line 419, column 5: " + [ v.external.constructor.name ]);
              })();
              var candidateList = (function () {
                  var xs = Data_Maybe.fromMaybe([  ])(v.external);
                  if (v.internal.candidates instanceof Data_Maybe.Just) {
                      return Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.snd)(Data_Array.filter(function ($350) {
                          return Data_Functor.flap(Data_Functor.functorFn)(Data_Set.member(Data_Ord.ordInt))(v.internal.candidates.value0)(Data_Tuple.fst($350));
                      })(Data_Array.mapWithIndex(function (idx) {
                          return function (it) {
                              return new Data_Tuple.Tuple(idx, it);
                          };
                      })(xs)));
                  };
                  if (v.internal.candidates instanceof Data_Maybe.Nothing) {
                      return xs;
                  };
                  throw new Error("Failed pattern match at Select line 401, column 9 - line 405, column 15: " + [ v.internal.candidates.constructor.name ]);
              })();
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("example-autocomplete") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(OnKeyDown.create)), Halogen_HTML_Properties.class_("autocomplete-input"), Halogen_HTML_Properties.value(inputValue), Halogen_HTML_Properties.ref(inputRef) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("autocomplete-menu") ])([ toUl(candidateList) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "candidates";
                  ...
                  return "selection";
              }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Show.showString))(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Show.showNumber))(Data_Maybe.showMaybe(Data_Set.showSet(Data_Show.showInt)))))(v.internal)) ]) ]);
          };
      };
  };
  var buildComponent = function (dictShow) {
      return function (li) {
          return function (initialState) {
              var spec = {
                  initialState: Data_Function["const"](initialState),
                  render: buildRender(dictShow)(li),
                  "eval": $$eval(dictShow),
  ...
  exports["Reset"] = Reset;
  exports["WindowPushUpperBoundary"] = WindowPushUpperBoundary;
  exports["WindowPushLowerBoundary"] = WindowPushLowerBoundary;
  ...
  exports["KeyUp"] = KeyUp;
  exports["KeyDown"] = KeyDown;
  exports["keyboardTransition"] = keyboardTransition;
  ...
  exports["ulRef"] = ulRef;
  exports["keySelectedRef"] = keySelectedRef;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Select.buildComponent(showItem)(Data_Show.show(showItem))({
