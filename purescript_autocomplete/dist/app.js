...
(function(exports) {
  ...
  var mouseTransition = function (v) {
      return function (event) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Select line 224, column 3 - line 230, column 61: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof KeyUp) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Select line 129, column 9 - line 137, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 119, column 5 - line 137, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Select line 150, column 9 - line 158, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 140, column 5 - line 158, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 117, column 3 - line 158, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Select line 92, column 38 - line 100, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Select line 333, column 3 - line 335, column 25: " + [ v3.value1.constructor.name ]);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 362, column 7 - line 364, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 388, column 7 - line 390, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
      ...
      throw new Error("Failed pattern match at Select line 302, column 1 - line 302, column 86: " + [ v.constructor.name ]);
  };
  var defaultConfig = {
      windowSize: 5,
      listSize: 10
