...
(function(exports) {
  ...
  var KeyboardInput = (function () {
      function KeyboardInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      KeyboardInput.create = function (value0) {
          return function (value1) {
              return new KeyboardInput(value0, value1);
          };
      };
  ...
  var scrollTransition = function (v) {
      return function (event) {
          return function (v1) {
              var keyOutOfWindow = function (k) {
                  return function (h) {
                      return k < h || k >= (h + v.windowSize | 0);
                  };
              };
              var updateKey = function (v2) {
                  return function (v3) {
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Data_Maybe.Nothing.value;
                      };
                      if (v2 instanceof Data_Maybe.Just) {
                          if (keyOutOfWindow(v2.value0)(v3)) {
                              return Data_Maybe.Nothing.value;
                          };
                          if (Data_Boolean.otherwise) {
                      ...
                      throw new Error("Failed pattern match at Select line 180, column 5 - line 180, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              if (event instanceof ScrollUp) {
                  ...
                  var v2 = (function () {
                      var $61 = windowAtUpperBoundary(v1.head);
                      if ($61) {
                          return new Data_Tuple.Tuple(v1.head, new Data_Maybe.Just(WindowPushUpperBoundary.value));
                      };
                      return new Data_Tuple.Tuple(v1.head - 1 | 0, Data_Maybe.Nothing.value);
                  })();
                  return withCmds(function (v3) {
                      var $63 = {};
                      for (var $64 in v3) {
                      ...
                      $63.key = updateKey(v1.key)(v2.value0);
                      $63.head = v2.value0;
                      return $63;
                  })(v2.value1);
              };
              if (event instanceof ScrollDown) {
                  var windowAtLowerBoundary = function (h) {
                      return h === (v.listSize - v.windowSize | 0);
                  };
                  var v2 = (function () {
                      var $68 = windowAtLowerBoundary(v1.head);
                      if ($68) {
                          return new Data_Tuple.Tuple(v1.head, new Data_Maybe.Just(WindowPushLowerBoundary.value));
                      };
                      return new Data_Tuple.Tuple(v1.head + 1 | 0, Data_Maybe.Nothing.value);
                  })();
                  return withCmds(function (v3) {
                      ...
                      $70.key = updateKey(v1.key)(v2.value0);
                      $70.head = v2.value0;
                      return $70;
                  })(v2.value1);
              };
              throw new Error("Failed pattern match at Select line 186, column 5 - line 208, column 69: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $83.mouse = new Data_Maybe.Just(event.value0);
                      return $83;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $87.mouse = Data_Maybe.Nothing.value;
                      return $87;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $90.mouse = new Data_Maybe.Just(event.value0);
                      return $90;
                  })(new Data_Maybe.Just(new Select(event.value0)));
              };
              throw new Error("Failed pattern match at Select line 226, column 3 - line 232, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $100.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $100;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $105.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $105;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $108.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $108.head = v1.head - 1 | 0;
                              return $108;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $111.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $111;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 131, column 9 - line 139, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 121, column 5 - line 139, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $116.key = new Data_Maybe.Just(v1.head);
                          return $116;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $124.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $124.head = v1.head + 1 | 0;
                              return $124;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $127.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $127;
                          })(Data_Maybe.Nothing.value);
                      };
                      throw new Error("Failed pattern match at Select line 152, column 9 - line 160, column 52: " + [ v3.constructor.name, v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Select line 142, column 5 - line 160, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Select line 119, column 3 - line 160, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  var empty = {
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Select line 94, column 38 - line 102, column 32: " + [ event.constructor.name ]);
          };
      };
  };
      ...
      return function (v) {
          if (v instanceof Sync) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $140.external = Data_Maybe.Just.create(Data_Foldable.foldl(dictFoldable)(function (acc) {
                      return function (x) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $153.internal = v3.value0(st.internal);
                          return $153;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Select line 311, column 3 - line 313, column 25: " + [ v3.value1.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $166.internal = v4.value0(st.internal);
                                  return $166;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Select line 327, column 7 - line 329, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $176.internal = v4.value0(st.internal);
                                  return $176;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v4.value1 instanceof Data_Maybe.Just) {
                                      ...
                                      throw new Error("Failed pattern match at Select line 337, column 7 - line 339, column 29: " + [ v4.value1.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
          ...
          throw new Error("Failed pattern match at Select line 289, column 1 - line 289, column 106: " + [ v.constructor.name ]);
      };
  };
  var defaultConfig = {
      windowSize: 3,
      ...
      return function (v) {
          var toLi = function (index) {
              return function (item) {
                  return Halogen_HTML_Elements.li([ Utils.classList([ new Data_Tuple.Tuple("autocomplete-item", true), new Data_Tuple.Tuple("key-selected", Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(index))(v.internal.key)) ]) ])([ Halogen_HTML_Core.text(li(item)) ]);
              };
          };
          var toUl = function (e) {
              var v1 = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Select line 234, column 1 - line 234, column 95: " + [ e.constructor.name ]);
              };
              if (e instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("autocomplete-list") ])(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (index) {
                      return function (acc) {
                          return function (item) {
