...
(function(exports) {// module Node.Express.Request
...
})(PS["QueryParams"] = PS["QueryParams"] || {});
(function(exports) {
    "use strict";
  var id = "id";
  exports["id"] = id;
})(PS["RouteParams"] = PS["RouteParams"] || {});
(function(exports) {
    "use strict";
  var Data_Either = PS["Data.Either"];
  var Effect = PS["Effect"];
  ...
  var initialState = [  ];
  var initialStateRef = Effect_Ref["new"](initialState);
  exports["initialState"] = initialState;
  exports["initialStateRef"] = initialStateRef;
})(PS["Types"] = PS["Types"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var Prelude = PS["Prelude"];
  var Types = PS["Types"];
  var getTodoWithIndexes = function (state) {
      ...
      return Data_Array.mapWithIndex(addId)(state);
  };
  var doneTodo = function (id) {
      return function (state) {
          var v = Data_Array.modifyAt(id)(function (v1) {
              return {
                  isDone: true,
          ...
          throw new Error("Failed pattern match at Transitions line 46, column 3 - line 54, column 8: " + [ v.constructor.name ]);
      };
  };
  var deleteTodo = function (id) {
      return function (state) {
          var v = Data_Array.deleteAt(id)(state);
          if (v instanceof Data_Maybe.Nothing) {
              return {
                  state: state,
                  value: new Data_Either.Left("No such Id.")
          ...
          throw new Error("Failed pattern match at Transitions line 34, column 3 - line 42, column 8: " + [ v.constructor.name ]);
      };
  };
  var addTodo = function (todo) {
      return function (state) {
          return {
              state: Data_Array.snoc(state)(todo),
              value: Data_Either.Right.create(Data_Array.length(state) + 1 | 0)
          };
      };
  };
  ...
  exports["getTodoWithIndexes"] = getTodoWithIndexes;
})(PS["Transitions"] = PS["Transitions"] || {});
(function(exports) {
    "use strict";
  var Control_Bind = PS["Control.Bind"];
  var Data_Array = PS["Data.Array"];
  ...
  var Node_Express_Types = PS["Node.Express.Types"];
  var Prelude = PS["Prelude"];
  var QueryParams = PS["QueryParams"];
  var RouteParams = PS["RouteParams"];
  var Transitions = PS["Transitions"];
  var Types = PS["Types"];                 
  ...
  var updateTodoHandler = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getRouteParam(Node_Express_Types.requestParamString)(RouteParams.id))(function (v) {
          return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getQueryParam(QueryParams.description))(function (v1) {
              if (v instanceof Data_Maybe.Nothing && v1 instanceof Data_Maybe.Nothing) {
                  return respondError(Effect_Exception.error("Both Id and Description are required."));
              };
              if (v instanceof Data_Maybe.Nothing && v1 instanceof Data_Maybe.Just) {
                  return respondError(Effect_Exception.error("Id is required."));
              };
              if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Nothing) {
                  return respondError(Effect_Exception.error("Description is required."));
              };
              if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Just) {
                  var v2 = Data_Int.fromString(v.value0);
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return respondError(Effect_Exception.error("Id must be an integer."));
                  };
                  if (v2 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref["modify'"](Transitions.deleteTodo(v2.value0))(stateRef)))(function (v3) {
                          if (v3 instanceof Data_Either.Left) {
                              return respondError(Effect_Exception.error(v3.value0));
                          };
                          ...
                          throw new Error("Failed pattern match at Handlers line 87, column 11 - line 89, column 57: " + [ v3.constructor.name ]);
                      });
                  };
                  throw new Error("Failed pattern match at Handlers line 83, column 7 - line 89, column 57: " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Handlers line 77, column 3 - line 89, column 57: " + [ v.constructor.name, v1.constructor.name ]);
          });
      });
  };

  // logger
  var logger = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref.read(stateRef)))(function (v) {
          return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getOriginalUrl)(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Console.log(">>> " + (v1 + (" count =" + Data_Show.show(Data_Show.showInt)(Data_Array.length(v)))))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_Handler.bindHandlerM)(Node_Express_Request.setUserData("logged")(v1))(function () {
  ...
  // /list
  var listTodosHandler = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref.read(stateRef)))(function (v) {
          return Node_Express_Response.sendJson(Transitions.getTodoWithIndexes(v));
      });
  };
  ...
  // /logger
  var getLoggerStatusHandler = function (v) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getUserData("logged"))(function (v1) {
          return Node_Express_Response.sendJson(Data_Maybe.fromMaybe("missing")(v1));
      });
  };
  ...
  var errorHandler = function (v) {
      return function (err) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_Handler.bindHandlerM)(Node_Express_Response.setStatus(500))(function () {
              return Node_Express_Response.sendJson({
                  error: Effect_Exception.message(err)
              });
          });
  ...
  // /done/:id
  var doneTodoHandler = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getRouteParam(Node_Express_Types.requestParamString)(RouteParams.id))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return respondError(Effect_Exception.error("Id is required."));
          };
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref["modify'"](Transitions.doneTodo(v1.value0))(stateRef)))(function (v2) {
                      if (v2 instanceof Data_Either.Left) {
                          return respondError(Effect_Exception.error(v2.value0));
                      };
                      return Node_Express_Response.sendJson({
                          status: "Done"
                      });
              ...
              throw new Error("Failed pattern match at Handlers line 98, column 7 - line 104, column 45: " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at Handlers line 95, column 3 - line 104, column 45: " + [ v.constructor.name ]);
      });
  };

  // /delete/:id
  var deleteTodoHandler = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getRouteParam(Node_Express_Types.requestParamString)(RouteParams.id))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return respondError(Effect_Exception.error("Id is required."));
          };
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref["modify'"](Transitions.deleteTodo(v1.value0))(stateRef)))(function (v2) {
                      if (v2 instanceof Data_Either.Left) {
                          return respondError(Effect_Exception.error(v2.value0));
                      };
                      return Node_Express_Response.sendJson({
              ...
              throw new Error("Failed pattern match at Handlers line 113, column 7 - line 119, column 48: " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at Handlers line 110, column 3 - line 119, column 48: " + [ v.constructor.name ]);
      });
  };

  // /create?desc=Do+something
  var createTodoHandler = function (stateRef) {
      return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getQueryParam(QueryParams.description))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return respondError(Effect_Exception.error("Description is required."));
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effect_Ref["modify'"](Transitions.addTodo({
                  description: v.value0,
                  isDone: false
              }))(stateRef)))(function (v1) {
                  return Node_Express_Response.sendJson({
                      status: "Created",
                      id: v1
                  });
          ...
          throw new Error("Failed pattern match at Handlers line 64, column 3 - line 70, column 49: " + [ v.constructor.name ]);
      });
  };
  exports["respondError"] = respondError;
  exports["logger"] = logger;
  exports["indexHandler"] = indexHandler;
  exports["listTodosHandler"] = listTodosHandler;
  exports["createTodoHandler"] = createTodoHandler;
  exports["updateTodoHandler"] = updateTodoHandler;
  exports["doneTodoHandler"] = doneTodoHandler;
  exports["deleteTodoHandler"] = deleteTodoHandler;
  exports["getLoggerStatusHandler"] = getLoggerStatusHandler;
  exports["errorHandler"] = errorHandler;
})(PS["Handlers"] = PS["Handlers"] || {});
...
(function(exports) {
  ...
  var todosCreate = todos + ("/" + "create");
  var todosDelete = todos + ("/" + ("delete" + ("/" + route(RouteParams.id))));
  var todosDone = todos + ("/" + ("done" + ("/" + route(RouteParams.id))));
  var todosUpdate = todos + ("/" + ("update" + ("/" + route(RouteParams.id))));
  var logger = root + "logger";
  exports["route"] = route;
  exports["root"] = root;
  exports["logger"] = logger;
  exports["todos"] = todos;
  exports["todosCreate"] = todosCreate;
  exports["todosUpdate"] = todosUpdate;
  exports["todosDelete"] = todosDelete;
  exports["todosDone"] = todosDone;
})(PS["ResourceNames"] = PS["ResourceNames"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var appSetup = function (stateRef) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Effect_Class.liftEffect(Node_Express_App.monadEffectAppM)(Effect_Console.log("Setting up")))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.setProp("json spaces")(4.0))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.use(Handlers.logger(stateRef)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.get(Node_Express_Types.routePath)(ResourceNames.root)(Handlers.indexHandler(stateRef)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.get(Node_Express_Types.routePath)(ResourceNames.todos)(Handlers.listTodosHandler(stateRef)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.post(Node_Express_Types.routePath)(ResourceNames.todosCreate)(Handlers.createTodoHandler(stateRef)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.post(Node_Express_Types.routePath)(ResourceNames.todosUpdate)(Handlers.updateTodoHandler(stateRef)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.post(Node_Express_Types.routePath)(ResourceNames.todosDelete)(Handlers.deleteTodoHandler(stateRef)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.post(Node_Express_Types.routePath)(ResourceNames.todosDone)(Handlers.doneTodoHandler(stateRef)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.get(Node_Express_Types.routePath)(ResourceNames.logger)(Handlers.getLoggerStatusHandler(stateRef)))(function () {
                                              return Node_Express_App.useOnError(Handlers.errorHandler(stateRef));
                                          });
                                      });
                                  });
                              });
  ...
  var main = function __do() {
      var v = Types.initialStateRef();
      var v1 = Node_Process.lookupEnv("Port")();
      var port = (function () {
          if (v1 instanceof Data_Maybe.Nothing) {
              return 8080;
          };
          if (v1 instanceof Data_Maybe.Just) {
              return Data_Maybe.fromMaybe(8080)(Data_Int.fromString(v1.value0));
          };
          throw new Error("Failed pattern match at Main line 53, column 14 - line 56, column 54: " + [ v1.constructor.name ]);
      })();
      var v2 = Node_Express_App.listenHttp(appSetup(v))(port)(function (v2) {
