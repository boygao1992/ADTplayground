...
(function($PS) {
  "use strict";
  $PS["Polaris.Data.Product.Variant"] = $PS["Polaris.Data.Product.Variant"] || {};
  var exports = $PS["Polaris.Data.Product.Variant"];
  ...
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var genericVariant = new Data_Generic_Rep.Generic(function (x) {
      return x;
  }, function (x) {
      return x;
  });
  var showVariant = new Data_Show.Show(function (x) {
      return Data_Generic_Rep_Show.genericShow(genericVariant)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "id";
          ...
          return "title";
      }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showNumber)))(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showNumber)))))(new Data_Symbol.IsSymbol(function () {
          return "Variant";
      })))(x);
  });      
  var deocdeJsonVariant = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "title";
  ...
  exports["deocdeJsonVariant"] = deocdeJsonVariant;
})(PS);
(function($PS) {
  "use strict";
  $PS["Polaris.Data.Product"] = $PS["Polaris.Data.Product"] || {};
  var exports = $PS["Polaris.Data.Product"];
  var Data_Argonaut_Decode_Class = $PS["Data.Argonaut.Decode.Class"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Generic_Rep_Show = $PS["Data.Generic.Rep.Show"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Polaris_Data_Product_Variant = $PS["Polaris.Data.Product.Variant"];
  var Products = function (x) {
      return x;
  };                                                                             
  var newtypeProducts = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Products);
  ...
  var showProduct = new Data_Show.Show(function (x) {
      return Data_Generic_Rep_Show.genericShow(genericProduct)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "id";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "product_type";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "vendor";
      }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showArray(Polaris_Data_Product_Variant.showVariant))))(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showNumber)))))(new Data_Symbol.IsSymbol(function () {
          return "Product";
      })))(x);
  });
  var showProducts = Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "products";
  }))(Data_Show.showRecordFieldsNil)(Data_Show.showArray(showProduct)));
  var deocdeJsonProduct = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeArray(Polaris_Data_Product_Variant.deocdeJsonVariant)))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "vendor";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "variants";
  }))()())(new Data_Symbol.IsSymbol(function () {
  ...
  var deocdeJsonProducts = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(deocdeJsonProduct))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "products";
  }))()())();
  exports["Products"] = Products;
  exports["genericProduct"] = genericProduct;
  exports["showProduct"] = showProduct;
  exports["deocdeJsonProduct"] = deocdeJsonProduct;
  exports["newtypeProducts"] = newtypeProducts;
  exports["showProducts"] = showProducts;
  exports["deocdeJsonProducts"] = deocdeJsonProducts;
})(PS);
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Api.Product"] = $PS["Polaris.UI.Api.Product"] || {};
  var exports = $PS["Polaris.UI.Api.Product"];
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Polaris_Data_Product = $PS["Polaris.Data.Product"];                
  var getProducts = function (hostname) {
      return Data_Functor.map(Effect_Aff.functorAff)(function (res) {
          return {
              body: Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Polaris_Data_Product.deocdeJsonProducts))(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Affjax_ResponseFormat.printResponseFormatError))(res.body),
              headers: res.headers,
              status: res.status,
              statusText: res.statusText
          };
      })(Affjax.get(Affjax_ResponseFormat.json)("/products?shop=" + hostname));
  };
...
(function($PS) {
  "use strict";
  $PS["Polaris.UI.Block.Table"] = $PS["Polaris.UI.Block.Table"] || {};
  var exports = $PS["Polaris.UI.Block.Table"];
  var Data_Functor = $PS["Data.Functor"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Ocelot_Block_Builder = $PS["Ocelot.Block.Builder"];
  var _table = "Polaris-DataTable__Table";
  var tableClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ _table ]);
  var table = Ocelot_Block_Builder.blockBuilder(Halogen_HTML_Elements.table)(tableClasses);
  var table_ = table([  ]);
  var _row = "Polaris-DataTable__TableRow";
  var rowClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ _row ]);
  var row = Ocelot_Block_Builder.blockBuilder(Halogen_HTML_Elements.tr)(rowClasses);
  var row_ = row([  ]);                                 
  var _cellHeader = "Polaris-DataTable__Cell--header";
  var _cell = "Polaris-DataTable__Cell";
  var cellClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ _cell ]);
  var cell = Ocelot_Block_Builder.blockBuilder(Halogen_HTML_Elements.td)(cellClasses);
  var cell_ = cell([  ]);
  var headerClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ _cell, _cellHeader ]);
  var header = Ocelot_Block_Builder.blockBuilder(Halogen_HTML_Elements.th)(headerClasses);
  var header_ = header([  ]);
  exports["_table"] = _table;
  exports["_row"] = _row;
  exports["_cell"] = _cell;
  exports["_cellHeader"] = _cellHeader;
  exports["tableClasses"] = tableClasses;
  exports["table"] = table;
  exports["table_"] = table_;
  exports["rowClasses"] = rowClasses;
  exports["row"] = row;
  exports["row_"] = row_;
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Polaris.UI.Component.Table.Product"] = $PS["Polaris.UI.Component.Table.Product"] || {};
  var exports = $PS["Polaris.UI.Component.Table.Product"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Show = $PS["Data.Show"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Polaris_UI_Block_Table = $PS["Polaris.UI.Block.Table"];
  var render = function (dictMonadAff) {
      return function (v) {
          var renderTextCell = function ($13) {
              return Polaris_UI_Block_Table.cell_((function (x) {
                  return [ x ];
              })(Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")($13))));
          };
          var renderHeader = Polaris_UI_Block_Table.row_([ Polaris_UI_Block_Table.header_([ Halogen_HTML_Core.text("id") ]), Polaris_UI_Block_Table.header_([ Halogen_HTML_Core.text("title") ]), Polaris_UI_Block_Table.header_([ Halogen_HTML_Core.text("vendor") ]), Polaris_UI_Block_Table.header_([ Halogen_HTML_Core.text("product type") ]) ]);
          var renderCell = function (dictShow) {
              return function ($14) {
                  return Polaris_UI_Block_Table.cell_((function (x) {
                      return [ x ];
                  })(Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Show.show(dictShow))($14)))));
              };
          };
          var renderData = function (v1) {
              return [ renderCell(Data_Show.showNumber)(v1.id), renderTextCell(v1.title), renderTextCell(v1.vendor), renderTextCell(v1.product_type) ];
          };
          var renderBody = Data_Functor.map(Data_Functor.functorArray)(Polaris_UI_Block_Table.row_)(Data_Functor.map(Data_Functor.functorArray)(renderData)(v.tableData));
          var renderTable = Polaris_UI_Block_Table.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderHeader ])(renderBody));
          return renderTable;
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: function (tableData) {
              return {
                  tableData: tableData
              };
          },
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Polaris.UI.Page"] = $PS["Polaris.UI.Page"] || {};
  var exports = $PS["Polaris.UI.Page"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Polaris_Data_Product = $PS["Polaris.Data.Product"];
  var Polaris_UI_Api_Product = $PS["Polaris.UI.Api.Product"];
  var Polaris_UI_Component_Table_Product = $PS["Polaris.UI.Component.Table.Product"];                
  var Initialize = (function () {
      function Initialize() {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("initialize")))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.hostname;
              }))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(function (v2) {
                      return v2.body;
                  })(Polaris_UI_Api_Product.getProducts(v1))))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.logShow(Data_Either.showEither(Data_Show.showString)(Polaris_Data_Product.showProducts))(v2)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $16.tableData = Data_Functor.map(Data_Maybe.functorMaybe)(function ($23) {
                                  return (function (v4) {
                                      return v4.products;
                                  })(Data_Newtype.unwrap(Polaris_Data_Product.newtypeProducts)($23));
                              })(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(v2));
                              return $16;
                          }))(function () {
  ...
  var defaultInitialState = {
      hostname: "",
      tableData: Data_Maybe.Nothing.value
  };
  var _table = Data_Symbol.SProxy.value;
  var render = function (dictMonadAff) {
      return function (v) {
          if (v.tableData instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Core.text("");
          };
          if (v.tableData instanceof Data_Maybe.Just) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "table";
              }))(Data_Ord.ordUnit)(_table)(Data_Unit.unit)(Polaris_UI_Component_Table_Product.component(dictMonadAff))(v.tableData.value0)(Data_Function["const"](Data_Maybe.Nothing.value));
          };
          throw new Error("Failed pattern match at Polaris.UI.Page (line 64, column 3 - line 67, column 68): " + [ v.tableData.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: function (hostname) {
              return {
                  hostname: hostname,
                  tableData: defaultInitialState.tableData
              };
          },
          render: render(dictMonadAff),
...
(function($PS) {
  ...
  var Polaris_UI_Page = $PS["Polaris.UI.Page"];                
  var main = function (hostname) {
      return function __do() {
          ...
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(Polaris_UI_Page.component(Effect_Aff_Class.monadAffAff))(hostname)(v));
          }))();
      };
  };
  exports["main"] = main;
