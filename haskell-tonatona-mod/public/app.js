...
(function(exports) {
  ...
  var readNumber = new Read(Data_Number.fromString);
...
(function(exports) {
  ...
  var toTextFieldError = new ToText(function (v) {
      ...
      throw new Error("Failed pattern match at Form.Validation (line 19, column 1 - line 19, column 47): " + [ v.constructor.name ]);
  });
  var toText = function (dict) {
      return dict.toText;
  };
  var strIsNumber = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          return Data_Maybe.maybe(Data_Either.Left.create(new InvalidNumber(str)))(Data_Either.Right.create)(Data_String_Read.read(Data_String_Read.readNumber)(str));
      });
  };
  var showError = function (dictToText) {
      return function ($12) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(toText(dictToText))(Data_Lens_Fold.preview(Formless_Data_FormFieldResult["_Error"](Data_Lens_Internal_Forget.choiceForget(Data_Maybe_First.monoidFirst)))($12));
      };
  };
  ...
  var minLength = function (dictMonad) {
      return function (n) {
          return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
              var l = Data_String_CodePoints.length(str);
              var $9 = l >= n;
              if ($9) {
                  return new Data_Either.Right(str);
              };
              return Data_Either.Left.create(new TooShort(n));
          });
      };
  };
  var enoughMoney = function (dictMonadAff) {
      return Formless_Validation.hoistFnME_((dictMonadAff.MonadEffect0()).Monad0())(function (i) {
          return Control_Bind.discard(Control_Bind.discardUnit)(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Data_Functor["void"](((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0())(Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff.delay(2000.0))))(function () {
              return Control_Applicative.pure(((dictMonadAff.MonadEffect0()).Monad0()).Applicative0())((function () {
                  var $10 = i < 1000.0;
                  if ($10) {
                      return new Data_Either.Right(i);
                  };
  ...
  var emailFormat = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $11 = Data_String_CodeUnits.contains("@")(str);
          if ($11) {
  ...
  var resultToHelp = function (dictToText) {
      return function (str) {
          return function (v) {
              ...
              return Data_Maybe.maybe(new Data_Either.Right(str))(Data_Either.Left.create)(Form_Validation.showError(dictToText)(v));
          };
      };
  };
  var p_ = function (str) {
  ...
  var field = function (config) {
      return function (contents) {
          ...
          return Halogen_HTML_Elements.div([ css("field") ])([ Halogen_HTML_Elements.div([ css("label") ])([ Halogen_HTML_Core.text(config.label) ]), Halogen_HTML_Elements.div([ css("control") ])(contents), (function () {
              ...
              throw new Error("Failed pattern match at Form.UI (line 106, column 5 - line 108, column 29): " + [ config.help.constructor.name ]);
          })() ]);
      };
  };
...
(function(exports) {
          ...
          return function (modifyResult) {
              return function ($$var) {
                  return function (rec) {
                      ...
                      var val = (function () {
                          var modifyInput = Data_Newtype.unwrap(Formless_Types_Form.newtypeInputFunction)(Data_Tuple.snd(rep));
                          ...
                          return Formless_Types_Form.FormField({
                              input: modifyInput(v.input),
                              touched: v.touched,
                              result: modifyResult(v.result)
                          });
                      })();
                      var label = Data_Tuple.fst(rep);
                      return Data_Newtype.wrap(dictNewtype1)(Record_Unsafe.unsafeSet(label)(val)(Data_Newtype.unwrap(dictNewtype1)(rec)));
                  };
              };
          };
      };
  ...
  var countErrors = function (dictRowToList) {
      return function (dictCountErrors) {
          return function (dictNewtype) {
              return function ($146) {
                  return countErrorsImpl(dictCountErrors)(Type_Row.RLProxy.value)(Data_Newtype.unwrap(dictNewtype)($146));
              };
          };
      };
  };
  ...
  var allTouched = function (dictRowToList) {
      return function (dictAllTouched) {
          return function (dictNewtype) {
              return function ($147) {
                  return allTouchedImpl(dictAllTouched)(Type_Row.RLProxy.value)(Data_Newtype.unwrap(dictNewtype)($147));
              };
          };
      };
  };
...
(function(exports) {
  ...
  var ModifyValidateAsync = (function () {
      function ModifyValidateAsync(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ModifyValidateAsync.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ModifyValidateAsync(value0, value1, value2);
              };
          };
      };
      return ModifyValidateAsync;
  })();
  var Reset = (function () {
  ...
  var LoadForm = (function () {
      function LoadForm(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LoadForm.create = function (value0) {
          return function (value1) {
              return new LoadForm(value0, value1);
          };
      };
      return LoadForm;
  })();
  ...
  exports["ModifyValidateAsync"] = ModifyValidateAsync;
  exports["Reset"] = Reset;
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Type_Data_Symbol = PS["Type.Data.Symbol"];                 
  var _internal = function (dictStrong) {
      return Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
          return "internal";
      }))()()(Data_Symbol.SProxy.value)(dictStrong);
  };
  var _form = function (dictStrong) {
      return Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
          return "form";
      }))()()(Data_Symbol.SProxy.value)(dictStrong);
  };
  var _InternalState = function (dictStrong) {
      return function ($6) {
          return _internal(dictStrong)(Data_Lens_Iso_Newtype["_Newtype"](Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(dictStrong.Profunctor0())($6));
      };
  };
  var _debouncerFields = function (dictStrong) {
      return function ($7) {
          return _InternalState(dictStrong)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
              return "debouncerFields";
          }))()()(Data_Symbol.SProxy.value)(dictStrong)($7));
      };
  };
  var _debouncerFieldM = function (label) {
      return function (dictStrong) {
          return function ($8) {
              return _debouncerFields(dictStrong)(Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(label)(dictStrong)($8));
          };
      };
  };
  exports["_internal"] = _internal;
  exports["_form"] = _form;
  exports["_InternalState"] = _InternalState;
  exports["_debouncerFields"] = _debouncerFields;
  exports["_debouncerFieldM"] = _debouncerFieldM;
})(PS["Formless.Type.Lenses"] = PS["Formless.Type.Lenses"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var modifyState = function (dictMonadState) {
      return function (f) {
          return Control_Bind.bindFlipped((dictMonadState.Monad0()).Bind1())(function ($15) {
              return Control_Applicative.pure((dictMonadState.Monad0()).Applicative0())(Data_Tuple.snd(Control_Comonad_Store.runStore($15)));
  ...
  var modifyingState = function (dictMonadState) {
      return function (p) {
          return function (f) {
              return Data_Functor["void"]((((dictMonadState.Monad0()).Bind1()).Apply0()).Functor0())(modifyState(dictMonadState)(Data_Lens_Setter.over(p)(f)));
          };
      };
  };
  ...
  var useState = function (dictMonadState) {
      return function (p) {
          return getsState(dictMonadState)(function (v) {
              return Data_Lens_Getter.viewOn(v)(p);
          });
      };
  };
  ...
  var assignState = function (dictMonadState) {
      return function (p) {
          return function (b) {
              return Data_Functor["void"]((((dictMonadState.Monad0()).Bind1()).Apply0()).Functor0())(modifyState(dictMonadState)(Data_Lens_Setter.set(p)(b)));
          };
      };
  };
  exports["getState"] = getState;
  ...
  exports["modifyingState"] = modifyingState;
...
(function(exports) {
  ...
  var Formless_Type_Lenses = PS["Formless.Type.Lenses"];
  var Formless_Types_Component = PS["Formless.Types.Component"];
  var Formless_Validation = PS["Formless.Validation"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
                                                                                      ...
                                                                                      return function (dictNewtype7) {
                                                                                          var initialState = function (v) {
                                                                                              return Control_Comonad_Store.store(v.render)({
                                                                                                  ...
                                                                                                  submitAttempts: 0,
                                                                                                  submitting: false,
                                                                                                  form: Formless_Internal_Transform.inputFieldsToFormFields(dictRowToList)(dictInputFieldsToFormFields)(dictNewtype1)(dictNewtype6)(v.initialInputs),
                                                                                                  internal: {
                                                                                                      allTouched: false,
                                                                                                      initialInputs: v.initialInputs,
                                                                                                      validators: v.validators,
                                                                                                      debouncerFields: Data_Map_Internal.empty
                                                                                                  }
                                                                                              });
                                                                                          };
  ...
  var runSubmit = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                              ...
                                                                                              $77.submitAttempts = st.submitAttempts + 1 | 0;
                                                                                              $77.submitting = true;
                                                                                              return $77;
                                                                                          }))(function (v) {
                                                                                              ...
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(!internal.allTouched)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                                                                                  ...
                                                                                                  $81.form = Formless_Internal_Transform.setFormFieldsTouched(dictRowToList1)(dictSetFormFieldsTouched)(dictNewtype6)(v.form);
                                                                                                  $81.internal = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v2) {
                                                                                                      return {
                                                                                                          allTouched: true,
                                                                                                          debouncerFields: v2.debouncerFields,
                                                                                                      ...
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                              ...
                                                                                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                                                                                                                  var $88 = Data_Eq.eq(Formless_Types_Component.eqValidStatus)(v2.validity)(Formless_Types_Component.Valid.value);
                                                                                                                  if ($88) {
                                                                                                                      return Formless_Internal_Transform.formFieldsToMaybeOutputFields(dictRowToList1)(dictNewtype6)(dictNewtype2)(dictFormFieldToMaybeOutput)(v2.form);
                                                                                                                  };
                                                                                                                  return Data_Maybe.Nothing.value;
                                                                                                              })());
                                                                                                          });
                                                                                          ...
                                                                                          var $$eval = function (v) {
                                                                                              if (v instanceof Formless_Types_Component.Initialize) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Initialize")));
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.Modify) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Modify")))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          var $91 = {};
                                                                                                          for (var $92 in st) {
                                                                                                          ...
                                                                                                          $91.form = Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype4)(dictNewtype6)(Control_Category.identity(Control_Category.categoryFn))(v.value0)(st.form);
                                                                                                          return $91;
                                                                                                      }))(function () {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Validate) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(Formless_Internal_Transform.unsafeRunValidationVariant((dictMonadAff.MonadEffect0()).Monad0())(dictNewtype3)(dictNewtype6)(dictNewtype7)(v.value0)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(v1.internal)).validators)(v1.form)))(function (v2) {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ModifyValidate) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("ModifyValidate")))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyingState(Halogen_Query_HalogenM.monadStateHalogenM)(Formless_Type_Lenses["_form"](Data_Profunctor_Strong.strongFn))(Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype4)(dictNewtype6)(Control_Category.identity(Control_Category.categoryFn))(v.value0)))(function () {
                                                                                                          return $$eval(new Formless_Types_Component.Validate(v.value0, v.value1));
                                                                                                      });
                                                                                                  });
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.ModifyValidateAsync) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("ModifyValidateAsync")))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyingState(Halogen_Query_HalogenM.monadStateHalogenM)(Formless_Type_Lenses["_form"](Data_Profunctor_Strong.strongFn))(Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype4)(dictNewtype6)(Control_Category.identity(Control_Category.categoryFn))(v.value1)))(function () {
                                                                                                          var label = (function () {
                                                                                                              var v1 = Data_Newtype.unwrap(dictNewtype4)(v.value1);
                                                                                                              return v1.type;
                                                                                                          })();
                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.useState(Halogen_Query_HalogenM.monadStateHalogenM)(Formless_Type_Lenses["_debouncerFieldM"](label)(Data_Lens_Internal_Forget.strongForget)))(function (v1) {
                                                                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                                                                                                  if (v1 instanceof Data_Maybe.Nothing) {
                                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (v2) {
                                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (v3) {
                                                                                                                              var debouncerFieldRow = {
                                                                                                                                  debouncer: v2,
                                                                                                                                  canceller: v3
                                                                                                                              };
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.assignState(Halogen_Query_HalogenM.monadStateHalogenM)(Formless_Type_Lenses["_debouncerFieldM"](label)(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(debouncerFieldRow)))(function () {
                                                                                                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(debouncerFieldRow);
                                                                                                                              });
                                                                                                                          });
                                                                                                                      });
                                                                                                                  };
                                                                                                                  ...
                                                                                                                  throw new Error("Failed pattern match at Formless.Component (line 155, column 25 - line 163, column 18): " + [ v1.constructor.name ]);
                                                                                                              })())(function (v2) {
                                                                                                                  var scheduleDebounceSignal = function (channel) {
                                                                                                                      return Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(v.value0))(function () {
                                                                                                                          return Effect_Aff_AVar.put(Data_Unit.unit)(channel);
                                                                                                                      })));
                                                                                                                  };
                                                                                                                  var interceptDebounceSignal = function ($172) {
                                                                                                                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.killFiber(Effect_Exception.error("renew delayed signal"))($172)));
                                                                                                                  };
                                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.read(v2.debouncer)))(function (v3) {
                                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.read(v2.canceller)))(function (v4) {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v4)(function (canceller) {
                                                                                                                              return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(canceller(Effect_Exception.error("intercept validation")));
                                                                                                                          }))(function () {
                                                                                                                              if (v3 instanceof Data_Maybe.Nothing) {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("initialize debouncer")))(function () {
                                                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_AVar.empty))(function (v5) {
                                                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(scheduleDebounceSignal(v5))(function (v6) {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.write(new Data_Maybe.Just({
                                                                                                                                                  channel: v5,
                                                                                                                                                  fiber: v6
                                                                                                                                              }))(v2.debouncer)))(function () {
                                                                                                                                                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_AVar.take(v5))))(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.write(Data_Maybe.Nothing.value)(v2.debouncer)))(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("debouncer timer expired, fork validation")))(function () {
                                                                                                                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)($$eval(Halogen_Query.action(Formless_Types_Component.Validate.create(v.value1)))))(function (v7) {
                                                                                                                                                                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.write(new Data_Maybe.Just(v7))(v2.canceller));
                                                                                                                                                              });
                                                                                                                                                          });
                                                                                                                                                      });
                                                                                                                                                  })));
                                                                                                                              ...
                                                                                                                              if (v3 instanceof Data_Maybe.Just) {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("renew debouncer")))(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(interceptDebounceSignal(v3.value0.fiber))(function () {
                                                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(scheduleDebounceSignal(v3.value0.channel))(function (v5) {
                                                                                                                                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.write(new Data_Maybe.Just({
                                                                                                                                                  channel: v3.value0.channel,
                                                                                                                                                  fiber: v5
                                                                                                                                              }))(v2.debouncer));
                                                                                                                                          });
                                                                                                                                      });
                                                                                                                              ...
                                                                                                                              throw new Error("Failed pattern match at Formless.Component (line 192, column 7 - line 224, column 82): " + [ v3.constructor.name ]);
                                                                                                                          });
                                                                                                                      });
                                                                                                                  });
                                                                                                              });
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Reset) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Reset")))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          var $125 = {};
                                                                                                          for (var $126 in st) {
                                                                                                          ...
                                                                                                          $125.form = Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype4)(dictNewtype6)(Control_Category.identity(Control_Category.categoryFn))(v.value0)(st.form);
                                                                                                          $125.internal = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v2) {
                                                                                                              return {
                                                                                                                  allTouched: false,
                                                                                                                  debouncerFields: v2.debouncerFields,
                                                                                                                  initialInputs: v2.initialInputs,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.SetAll) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("SetAll")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          return {
                                                                                                              form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype1)(dictNewtype6)(v.value0)(st.form),
                                                                                                              dirty: st.dirty,
                                                                                                              errors: st.errors,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ModifyAll) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("ModifyAll")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          return {
                                                                                                              form: Formless_Internal_Transform.modifyAll(dictRowToList1)(dictModifyAll)(dictNewtype5)(dictNewtype6)(v.value0)(st.form),
                                                                                                              dirty: st.dirty,
                                                                                                              errors: st.errors,
                                                                                                              internal: st.internal,
                                                                                                              submitAttempts: st.submitAttempts,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ValidateAll) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("ValidateAll")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(Formless_Internal_Transform.validateAll(dictRowToList1)((dictMonadAff.MonadEffect0()).Monad0())(dictValidateAll)(dictNewtype7)(dictNewtype6)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(v1.internal)).validators)(v1.form)))(function (v2) {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                                                                                  var $138 = {};
                                                                                                                  for (var $139 in v3) {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.SyncFormData) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("SyncFormData")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                          var errors = Formless_Internal_Transform.countErrors(dictRowToList1)(dictCountErrors)(dictNewtype6)(v1.form);
                                                                                                          var dirty = Data_Eq.notEq(Data_Eq.eqRec(dictRowToList)(dictEqRecord))(Data_Newtype.unwrap(dictNewtype1)(Formless_Internal_Transform.formFieldsToInputFields(dictRowToList1)(dictFormFieldsToInputFields)(dictNewtype1)(dictNewtype6)(v1.form)))(Data_Newtype.unwrap(dictNewtype1)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(v1.internal)).initialInputs));
                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                                                                                              var $143 = (Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(v1.internal)).allTouched;
                                                                                                              if ($143) {
                                                                                                                  return Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                                                                                                      return {
                                                                                                                          validity: (function () {
                                                                                                                              var $144 = v1.errors !== 0;
                                                                                                                              if ($144) {
                                                                                                                          ...
                                                                                                                          form: v2.form,
                                                                                                                          submitAttempts: v2.submitAttempts,
                                                                                                                          submitting: v2.submitting
                                                                                                                      };
                                                                                                                  });
                                                                                                              };
                                                                                                              var $145 = Formless_Internal_Transform.allTouched(dictRowToList1)(dictAllTouched)(dictNewtype6)(v1.form);
                                                                                                              if ($145) {
                                                                                                                  return Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                                                                                                      return {
                                                                                                                          validity: (function () {
                                                                                                                          ...
                                                                                                                          internal: Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v3) {
                                                                                                                              return {
                                                                                                                                  allTouched: true,
                                                                                                                                  debouncerFields: v3.debouncerFields,
                                                                                                              ...
                                                                                                              return Halogen_Query_HalogenM.raise(Formless_Types_Component.Changed.create(getPublicState(v2)));
                                                                                                          });
                                                                                                      });
                                                                                                  }));
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.Submit) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Submit")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runSubmit)(function (v1) {
                                                                                                          return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($173) {
                                                                                                              return Halogen_Query_HalogenM.raise(Formless_Types_Component.Submitted.create($173));
                                                                                                          })(v1);
                                                                                                      });
                                                                                                  }));
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.SubmitReply) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("SubmitReply")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runSubmit)(function (v1) {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ResetAll) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("ResetAll")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          return {
                                                                                                              validity: Formless_Types_Component.Incomplete.value,
                                                                                                              dirty: false,
                                                                                                              ...
                                                                                                              submitAttempts: 0,
                                                                                                              submitting: false,
                                                                                                              form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype1)(dictNewtype6)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(st.internal)).initialInputs)(st.form),
                                                                                                          ...
                                                                                                          return Halogen_Query_HalogenM.raise(Formless_Types_Component.Changed.create(getPublicState(v1)));
                                                                                                      });
                                                                                                  }));
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.GetState) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("GetState")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Send) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Send")))(function () {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Raise) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Raise")))(function () {
                                                                                                      return Halogen_Query_HalogenM.raise(new Formless_Types_Component.Emit(v.value0));
                                                                                                  }));
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.LoadForm) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("LoadForm")))(function () {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                                                                                              return {
                                                                                                                  ...
                                                                                                                  submitAttempts: 0,
                                                                                                                  submitting: false,
                                                                                                                  form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype1)(dictNewtype6)(v.value0)(v1.form),
                                                                                                                  internal: Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v3) {
                                                                                                                      return {
                                                                                                                          allTouched: false,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Receive) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("Receive")))(function () {
                                                                                                      var applyOver = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v1) {
                                                                                                          return {
                                                                                                              ...
                                                                                                              debouncerFields: v1.debouncerFields,
                                                                                                              initialInputs: v1.initialInputs
                                                                                                          };
                                                                                                      });
                                                                                                      return Renderless_State.modifyStore_(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0.render)(function (st) {
                                                                                                          return {
                                                                                                              validity: st.validity,
                                                                                                              dirty: st.dirty,
                                                                                                              submitting: st.submitting,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.AndThen) {
                                                                                                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("AndThen")))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)($$eval(v.value0)))(function () {
                                                                                                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)($$eval(v.value1));
                                                                                                      });
                                                                                                  }));
                                                                                              };
                                                                                              throw new Error("Failed pattern match at Formless.Component (line 95, column 10 - line 387, column 21): " + [ v.constructor.name ]);
                                                                                          };
                                                                                          return Halogen_Component.lifecycleParentComponent(dictOrd)({
                                                                                              ...
                                                                                              initializer: Data_Maybe.Just.create(Halogen_Query.action(Formless_Types_Component.Initialize.create)),
                                                                                              finalizer: Data_Maybe.Nothing.value
                                                                                          });
                                                                                      };
                                                                                  };
      ...
      return function (dictNewtype) {
          return function (dictCons) {
              return function (ms) {
                  return function (sym) {
                      return function (i) {
                          return Formless_Types_Component.ModifyValidateAsync.create(ms)(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(Data_Function["const"](i)))));
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var showBalance = Data_Show.showNumber;
  ...
  var newtypeDonateForm = new Data_Newtype.Newtype(function (n) {
      return n;
  }, DonateForm);
  var renderForm = function (v) {
      return Form_UI.formContent_([ Form_UI.input({
          label: "Name",
          help: Form_UI.resultToHelp(Form_Validation.toTextFieldError)("Write your name")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeDonateForm)()((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "balance";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).name)(v.form)),
          ...
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).name)(v.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(newtypeDonateForm)()((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).name))) ]), Form_UI.input({
          label: "Email",
          help: Form_UI.resultToHelp(Form_Validation.toTextFieldError)("Provide your email address")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(newtypeDonateForm)()((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "balance";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "name";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).email)(v.form)),
          ...
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).email)(v.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.asyncSetValidate(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(newtypeDonateForm)()(300.0)((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).email))) ]), Form_UI.input({
          label: "Donation",
          help: Form_UI.resultToHelp(Form_Validation.toTextFieldError)("How many dollas do you want to spend?")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "balance";
          }))(newtypeDonateForm)()((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "balance";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "name";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).balance)(v.form)),
          placeholder: "1000"
      })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))(newtypeDonateForm)()((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).balance)(v.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.asyncSetValidate(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))(newtypeDonateForm)()(1000.0)((prx()(newtypeDonateForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).balance))) ]), Form_UI.buttonPrimary([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.submit)) ])([ Halogen_HTML_Core.text("Submit") ]) ]);
  };
  var newtypeBalance = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Balance);
  var validators = function (dictMonadAff) {
      return {
          name: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation((dictMonadAff.MonadEffect0()).Monad0()))(Form_Validation.minLength((dictMonadAff.MonadEffect0()).Monad0())(5))(Formless_Validation.hoistFn_((dictMonadAff.MonadEffect0()).Monad0())(Data_Newtype.wrap(newtypeName))),
          email: Form_Validation.emailFormat((dictMonadAff.MonadEffect0()).Monad0()),
          balance: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation((dictMonadAff.MonadEffect0()).Monad0()))(Form_Validation.strIsNumber((dictMonadAff.MonadEffect0()).Monad0()))(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation((dictMonadAff.MonadEffect0()).Monad0()))(Form_Validation.enoughMoney(dictMonadAff))(Formless_Validation.hoistFn_((dictMonadAff.MonadEffect0()).Monad0())(Data_Newtype.wrap(newtypeBalance))))
      };
  };
  var initialInputs = Formless_Transform_Row.mkInputFields()(newtypeDonateForm)(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "balance";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "email";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Types_Form.FormProxy.value);
  var render = function (v) {
      return Form_UI.section_([ Form_UI.h1_([ Halogen_HTML_Core.text("Formless") ]), Form_UI.h2_([ Halogen_HTML_Core.text("A form with debounced async fields.") ]), Form_UI.p_("If you have fields with expensive validation, you can debounce modifications to the field " + ("with the async versions of setValidate and modifyValidate query functions. The result " + ("type of the form field lets you know whether the field has not been validated, is " + "currently validating, or has produced an error or result."))), Halogen_HTML_Elements.br_, Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "name";
          ...
          return "balance";
      }))(Effect_Aff.monadAff)()(newtypeDonateForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Effect_Aff.monadAff)()(newtypeDonateForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(Effect_Aff.monadAff)()(newtypeDonateForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationNil(Effect_Aff.monadAff)))))(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
          return "balance";
      }))()(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))()(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm)(newtypeDonateForm))({
          initialInputs: initialInputs,
          validators: validators(Effect_Aff_Class.monadAffAff),
          render: renderForm
  ...
  var $$eval = function (v) {
      if (v.value0 instanceof Formless_Types_Component.Submitted) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
              var result = Formless_Transform_Record.unwrapOutputFields(newtypeDonateForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "balance";
              ...
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "name";
              }))(Data_Show.showRecordFieldsNil)(showName))(Form_Validation.showEmail))(showBalance)))(result));
          })());
      };
      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
  };
  var component = Halogen_Component.parentComponent(Data_Ord.ordUnit)({
  ...
  exports["newtypeBalance"] = newtypeBalance;
  exports["showBalance"] = showBalance;
  exports["newtypeDonateForm"] = newtypeDonateForm;
...
(function(exports) {
  ...
  var runUI = function ($2) {
      return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(Example_Async_Component.component)(Data_Unit.unit)($2));
  };
