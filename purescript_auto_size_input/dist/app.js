...
(function(exports) {
  ...
  "use strict";
  var item = "item";
  var ghostItem = "ghost-item";
  var container = "container";
  exports["container"] = container;
  exports["item"] = item;
  exports["ghostItem"] = ghostItem;
...
(function(exports) {
  ...
  var byClass = function ($2) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Class.create($2)));
  };
...
(function(exports) {
  ...
  var Data_Ord = PS["Data.Ord"];
  var Prelude = PS["Prelude"];                                                                       
  var valVisibility = new CSS_Property.Val(function (v) {
      return v;
  });
  var visibility = CSS_Stylesheet.key(valVisibility)(CSS_String.fromString(CSS_Property.isStringKey)("visibility"));
  var hiddenVisibility = CSS_Common.hiddenValue;
  var visibilityHidden = CSS_Common.hidden(hiddenVisibility);
  exports["visibilityHidden"] = visibilityHidden;
  exports["visibility"] = visibility;
  exports["hiddenVisibility"] = hiddenVisibility;
  exports["valVisibility"] = valVisibility;
})(PS["Visibility"] = PS["Visibility"] || {});
(function(exports) {
    "use strict";
  var CSS = PS["CSS"];
  ...
  var Control_Bind = PS["Control.Bind"];
  var Prelude = PS["Prelude"];
  var Visibility = PS["Visibility"];                 
  var item = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Color_Scheme_X11.lightgreen))(function () {
          return CSSUtils.margin1(CSS_Size.em(0.2));
      });
  });

  // | CSS function
  var inputWidth = function (x) {
      return CSS_Geometry.width(CSS_Size.px(x));
  };
  var ghostItem = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.nil))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Overflow.overflow(CSS_Overflow.hidden))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.nil))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Visibility.visibility(Visibility.visibilityHidden))(function () {
  ...
  // | CSS
  var container = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(600.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(200.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Color.black))(function () {
              return CSS_Display.position(CSS_Display.relative);
          });
      });
  });
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.container))(container))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.item))(item))(function () {
          return CSS_Stylesheet.select(CSSUtils.class_(ClassNames.ghostItem))(ghostItem);
      });
  });
  exports["container"] = container;
  exports["item"] = item;
...
(function(exports) {
  ...
  var inputRef = "auto-size-input";
  var ghostRef = "auto-size-input-ghost";
  var render = function (v) {
      var renderItem = function (str) {
          return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.item ]) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(OnClick.create(str))) ])([ Halogen_HTML_Core.text("x") ]), Halogen_HTML_Core.text(str) ]);
      };
      var renderList = Data_Functor.map(Data_Functor.functorArray)(renderItem);
      var renderAutoSizeInput = function (v1) {
          return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.item ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(OnInput.create)), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(OnKeyDown.create)), Halogen_HTML_CSS.style(Styles.inputWidth(v1.width)), Halogen_HTML_Properties.ref(inputRef) ]) ]);
      };
      return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.container ]) ])([ Halogen_HTML_Elements.div_(Data_Array.snoc(renderList(v.selections))(renderAutoSizeInput(v.input))), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.ghostItem ]), Halogen_HTML_Properties.ref(ghostRef) ])([ Halogen_HTML_Core.text(v.input.text) ]), Halogen_HTML_CSS.stylesheet(Styles.root) ]);
  };
  var emptyInputState = {
      text: "",
      width: 0.0
  ...
  var $$eval = function (v) {
      if (v instanceof OnInput) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $24 = {};
              for (var $25 in st) {
              ...
              $24.input = (function () {
                  var $21 = {};
                  for (var $22 in st.input) {
                      if ({}.hasOwnProperty.call(st.input, $22)) {
                          $21[$22] = st["input"][$22];
                      };
                  };
                  $21.text = v.value0;
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ghostRef))(function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.clientWidth(Web_HTML_HTMLElement.toElement(v1.value0))))(function (v2) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $33.input = (function () {
                                  var $30 = {};
                                  for (var $31 in st.input) {
                                      if ({}.hasOwnProperty.call(st.input, $31)) {
                                          $30[$31] = st["input"][$31];
                                      };
                                  };
                                  $30.width = v2;
                  ...
                  throw new Error("Failed pattern match at AutoSize line 107, column 3 - line 113, column 16: " + [ v1.constructor.name ]);
              });
          }));
      };
          ...
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
              ...
              if (v1 === "Enter") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $40.input = emptyInputState;
                      $40.selections = Data_Array.snoc(st.selections)(st.input.text);
                      return $40;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(inputRef))(function (v2) {
                          return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($51) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.focus($51));
                          })(v2);
                      });
                  });
              };
      ...
      if (v instanceof OnClick) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $46 = {};
              for (var $47 in st) {
              ...
              $46.selections = Data_Array.filter(function ($52) {
                  return !(function (v2) {
                      return v2 === v.value0;
                  })($52);
              })(st.selections);
      ...
      throw new Error("Failed pattern match at AutoSize line 103, column 1 - line 103, column 54: " + [ v.constructor.name ]);
  };
  var initialState = {
  ...
  exports["OnKeyDown"] = OnKeyDown;
  exports["OnClick"] = OnClick;
  exports["emptyInputState"] = emptyInputState;
  exports["initialState"] = initialState;
  exports["inputRef"] = inputRef;
  exports["ghostRef"] = ghostRef;
  exports["render"] = render;
  exports["component"] = component;
})(PS["AutoSize"] = PS["AutoSize"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Error_Class = PS["Control.Monad.Error.Class"];
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          return Halogen_VDom_Driver.runUI(AutoSize.component)(Data_Unit.unit)(Data_Maybe.fromMaybe(v)(v1));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
