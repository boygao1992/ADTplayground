  ...
  var $$eval = function (v) {
      if (v instanceof OnInput) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $22.input = (function () {
                  var $19 = {};
                  for (var $20 in st.input) {
                      if ({}.hasOwnProperty.call(st.input, $20)) {
                          $19[$20] = st["input"][$20];
                      };
                  };
                  $19.text = v.value0;
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ghostRef))(function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_DOM_Element.clientWidth(Web_HTML_HTMLElement.toElement(v1.value0))))(function (v2) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $31.input = (function () {
                                  var $28 = {};
                                  for (var $29 in st.input) {
                                      if ({}.hasOwnProperty.call(st.input, $29)) {
                                          $28[$29] = st["input"][$29];
                                      };
                                  };
                                  $28.width = v2;
                  ...
                  throw new Error("Failed pattern match at AutoSize line 101, column 3 - line 107, column 16: " + [ v1.constructor.name ]);
              });
          }));
      };
          ...
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
              ...
              if (v1 === "Enter") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $38.input = emptyInputState;
                      $38.selections = Data_Array.snoc(st.selections)(st.input.text);
                      return $38;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(inputRef))(function (v2) {
                          return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($44) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.focus($44));
                          })(v2);
                      });
                  });
              };
      ...
      throw new Error("Failed pattern match at AutoSize line 97, column 1 - line 97, column 54: " + [ v.constructor.name ]);
  };
  var initialState = {
