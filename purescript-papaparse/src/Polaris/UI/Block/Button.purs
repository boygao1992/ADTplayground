...
buttonText
  ...
  -> Array (HTML p i)
  -> HTML p i
buttonText = blockBuilder HH.span $ ClassName <$> [ _buttonText ]
...
buttonIcon
  ...
  -> Array (HTML p i)
  -> HTML p i
buttonIcon = blockBuilder HH.span $ ClassName <$> [ _buttonIcon ]

buttonIcon_
  :: forall p i
  . Array (HTML p i)
  -> HTML p i
buttonIcon_ = buttonIcon []
...
buttonSpinner
  ...
  -> Array (HTML p i)
  -> HTML p i
buttonSpinner = blockBuilder HH.span $ ClassName <$> [ _buttonSpinner ]

buttonSpinner_
  :: forall p i
  . Array (HTML p i)
  -> HTML p i
buttonSpinner_ = buttonSpinner []
