...
(function($PS) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Component.Checkbox.Renderless (line 53, column 16 - line 61, column 25): " + [ v.constructor.name ]);
      };
  };                              
...
(function($PS) {
  ...
  var defaultInitialState = {
      allCategories: Data_Monoid.mempty(Data_Monoid.monoidArray),
      expand: Ocelot_Block_Expandable.Expanded.value,
      validity: Data_Maybe.Nothing.value
  };
      ...
      return function (v) {
          if (v instanceof ToggleExpand) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $17.expand = Data_HeytingAlgebra.not(Ocelot_Block_Expandable.heytingAlgebraStatus)(st.expand);
                  return $17;
              });
          };
          if (v instanceof HandleCategory) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.queryAll()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $21.validity = Data_Foldable.foldMap(Data_Map_Internal.foldableMap)(Data_Maybe.monoidMaybe(Magento_Import_UI_Data_Validity.semigroupValidity))(Control_Category.identity(Control_Category.categoryFn))(v1);
                      return $21;
                  });
              });
          };
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.queryAll()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $27.validity = Data_Foldable.foldMap(Data_Map_Internal.foldableMap)(Data_Maybe.monoidMaybe(Magento_Import_UI_Data_Validity.semigroupValidity))(Control_Category.identity(Control_Category.categoryFn))(v1);
                      return $27;
                  });
              });
          };
          throw new Error("Failed pattern match at Magento.Import.UI.Container.Categories (line 104, column 16 - line 114, column 51): " + [ v.constructor.name ]);
      };
  };
  var handleQuery = function (dictMonadAff) {
      return function (v) {
      ...
      return function (v) {
          var renderCategory = function (v1) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(HandleCategory.create(v1.value0)($40));
              });
          };
          return Ocelot_Block_Card.card([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ Magento_Import_UI_Data_Validity.backgroundColorLightest(v.validity) ])) ])([ Ocelot_Block_Expandable.heading([ Halogen_HTML_Events.onClick(function ($41) {
              return Data_Maybe.Just.create(Data_Function["const"](ToggleExpand.value)($41));
          }) ])([ Halogen_HTML_Core.text("Categories") ]), Ocelot_Block_Expandable.content_(v.expand)(Data_Functor.map(Data_Functor.functorArray)(renderCategory)(v.allCategories)) ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: function (allCategories) {
              return {
...
(function($PS) {
  ...
  var parseFile = function ($6) {
      return Data_Functor.map(Effect.functorEffect)(function (result) {
          var $1 = Data_Array["null"](result.errors);
          if ($1) {
              return new Data_Either.Right(result.data);
          };
          return new Data_Either.Left(result.errors);
      })(parseRaw($6));
  };
  var parseFileHeadedList = (function () {
      var _parseFileHeadedList = function (file) {
          var v = Data_Array.uncons(file);
          if (v instanceof Data_Maybe.Just) {
              return Data_Either.Right.create(Data_Functor.map(Data_Functor.functorArray)(Data_Array.zip(v.value0.head))(v.value0.tail));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return new Data_Either.Left([  ]);
          };
          throw new Error("Failed pattern match at PapaParse (line 60, column 33 - line 62, column 24): " + [ v.constructor.name ]);
      };
      return function ($7) {
          return Data_Functor.map(Effect.functorEffect)(Data_Functor.flap(Data_Functor.functorFn)(Control_Bind.bind(Data_Either.bindEither))(_parseFileHeadedList))(parseFile($7));
      };
  })();
  exports["parseRaw"] = parseRaw;
  exports["parseFile"] = parseFile;
  exports["parseFileHeadedList"] = parseFileHeadedList;
})(PS);
(function(exports) {
  "use strict";
          ...
          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Halogen_Query_HalogenM.monadHalogenM)(Halogen_Util.debugShow(Data_MediaType.showMediaType)(dictMonadAff)(v.value0.value0.mediaType)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Applicative.when(Control_Monad_Maybe_Trans.applicativeMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Data_Eq.notEq(Data_MediaType.eqMediaType)(v.value0.value0.mediaType)(Data_MediaType_Extra.applicationXLSX) && Data_Eq.notEq(Data_MediaType.eqMediaType)(v.value0.value0.mediaType)(Data_MediaType_Common.textCSV))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Halogen_Query_HalogenM.monadHalogenM)(Halogen_Query_HalogenM.raise(new $$Error(UnsupportedFileType.value))))(function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))((function () {
                      ...
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Halogen_Query_HalogenM.monadHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(PapaParse.parseFileHeadedList(v1))))(function (v2) {
                          return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Halogen_Query_HalogenM.monadHalogenM)(Halogen_Query_HalogenM.raise((function () {
                              ...
                              if (v2 instanceof Data_Either.Right) {
                                  return new FileLoaded(v2.value0);
                              };
                              throw new Error("Failed pattern match at Magento.Import.UI.Container.TabularFilePicker (line 99, column 26 - line 101, column 35): " + [ v2.constructor.name ]);
                          })()));
                      });
                  });
              });
      ...
      return function (v) {
          if (v instanceof HandleFilePicker) {
              if (v.value0 instanceof Magento_Import_UI_Container_TabularFilePicker.FileLoaded) {
                  return Halogen_Util.debugShow(Data_Show.showArray(Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showString)(Data_Show.showString))))(dictMonadAff)(v.value0.value0);
              };
              ...
              throw new Error("Failed pattern match at Magento.Import.UI.Page (line 103, column 25 - line 108, column 77): " + [ v.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Page (line 102, column 16 - line 115, column 57): " + [ v.constructor.name ]);
      };
  };
  var render = function (dictMonadAff) {
      return function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return "filePicker";
          }))(Data_Ord.ordUnit)(_filePicker)(Data_Unit.unit)(Magento_Import_UI_Container_TabularFilePicker.component(dictMonadAff))(Data_Unit.unit)(function ($14) {
              return Data_Maybe.Just.create(HandleFilePicker.create($14));
          }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "categories";
          }))(Data_Ord.ordUnit)(_categories)(Data_Unit.unit)(Magento_Import_UI_Container_Categories.component(dictMonadAff))([ new Data_Tuple.Tuple("A", [ {
              ...
              validity: false
          } ]) ])(Data_Function["const"](Data_Maybe.Nothing.value)), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($15) {
              return Data_Maybe.Just.create(Data_Function["const"](GetAllValidCategories.value)($15));
          }) ])([ Halogen_HTML_Core.text("getAllValidCategories") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($16) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup.Success.value,
                  message: "success"
              }))($16));
          }) ])([ Halogen_HTML_Core.text("Success") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($17) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup.Warning.value,
                  message: "warning"
              }))($17));
          }) ])([ Halogen_HTML_Core.text("Warning") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($18) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup["Error"].value,
