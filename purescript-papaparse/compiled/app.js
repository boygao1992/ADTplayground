...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Magento.Import.UI.Component.Checkbox"] = $PS["Magento.Import.UI.Component.Checkbox"] || {};
  var exports = $PS["Magento.Import.UI.Component.Checkbox"];
  var Data_Symbol = $PS["Data.Symbol"];
...
(function($PS) {
  "use strict";
  $PS["Magento.Import.UI.Component.Renderless.Checkbox"] = $PS["Magento.Import.UI.Component.Renderless.Checkbox"] || {};
  var exports = $PS["Magento.Import.UI.Component.Renderless.Checkbox"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Comonad = $PS["Control.Comonad"];
  var Control_Comonad_Store = $PS["Control.Comonad.Store"];
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Component.Renderless.Checkbox (line 53, column 16 - line 61, column 25): " + [ v.constructor.name ]);
      };
  };                              
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Magento.Import.UI.Component.Renderless.Checkbox.Setters"] = $PS["Magento.Import.UI.Component.Renderless.Checkbox.Setters"] || {};
  var exports = $PS["Magento.Import.UI.Component.Renderless.Checkbox.Setters"];
  var DOM_HTML_Indexed_InputType = $PS["DOM.HTML.Indexed.InputType"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Magento_Import_UI_Component_Renderless_Checkbox = $PS["Magento.Import.UI.Component.Renderless.Checkbox"];                
  var setProps = function (b) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Events.onChange(function ($0) {
          return Data_Maybe.Just.create(Data_Function["const"](Magento_Import_UI_Component_Renderless_Checkbox.Toggle.value)($0));
...
(function($PS) {
  "use strict";
  $PS["Magento.Import.UI.Component.Renderless.TextField"] = $PS["Magento.Import.UI.Component.Renderless.TextField"] || {};
  var exports = $PS["Magento.Import.UI.Component.Renderless.TextField"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Comonad = $PS["Control.Comonad"];
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Component.Renderless.TextField (line 53, column 16 - line 59, column 33): " + [ v.constructor.name ]);
      };
  };                           
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Magento.Import.UI.Component.Renderless.TextField.Setters"] = $PS["Magento.Import.UI.Component.Renderless.TextField.Setters"] || {};
  var exports = $PS["Magento.Import.UI.Component.Renderless.TextField.Setters"];
  var DOM_HTML_Indexed_InputType = $PS["DOM.HTML.Indexed.InputType"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Events = $PS["Halogen.HTML.Events"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Magento_Import_UI_Component_Renderless_TextField = $PS["Magento.Import.UI.Component.Renderless.TextField"];                
  var setProps = function (str) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($0) {
          return Data_Maybe.Just.create(Magento_Import_UI_Component_Renderless_TextField.KeyboardInput.create($0));
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Magento.Import.UI.Component.TextField"] = $PS["Magento.Import.UI.Component.TextField"] || {};
  var exports = $PS["Magento.Import.UI.Component.TextField"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Magento_Import_UI_Component_Renderless_TextField_Setters = $PS["Magento.Import.UI.Component.Renderless.TextField.Setters"];
  var Ocelot_Block_Input = $PS["Ocelot.Block.Input"];                
  var render = function (dictMonadAff) {
      return function (st) {
          return Ocelot_Block_Input.input(Magento_Import_UI_Component_Renderless_TextField_Setters.setProps(st)([  ]));
      };
  };
...
(function($PS) {
  ...
  var Magento_Import_UI_Component_Checkbox = $PS["Magento.Import.UI.Component.Checkbox"];
  var Magento_Import_UI_Component_Renderless_Checkbox = $PS["Magento.Import.UI.Component.Renderless.Checkbox"];
  var Magento_Import_UI_Component_Renderless_Checkbox_Setters = $PS["Magento.Import.UI.Component.Renderless.Checkbox.Setters"];
  var Magento_Import_UI_Component_Renderless_TextField = $PS["Magento.Import.UI.Component.Renderless.TextField"];
  var Magento_Import_UI_Component_TextField = $PS["Magento.Import.UI.Component.TextField"];
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Container.Categories.Item (line 115, column 16 - line 128, column 1): " + [ v.constructor.name ]);
      };
  };       
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var $48 = Data_Eq.eq(eqValidity)(v1.validity)(Valid.value) && v1.selected === true;
              if ($48) {
  ...
  var render = function (dictMonadAff) {
      return function (st) {
          var renderCheckbox = function (b) {
              return Ocelot_Block_Checkbox.checkbox_(Magento_Import_UI_Component_Renderless_Checkbox_Setters.setProps(b)([ Halogen_HTML_Properties.disabled(Data_Eq.notEq(eqValidity)(st.validity)(Valid.value)) ]))([  ]);
          };
          return Ocelot_Block_Input.inputGroup_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "textField";
          }))(Data_Ord.ordUnit)(Magento_Import_UI_Component_TextField["_textField"])(Data_Unit.unit)(Magento_Import_UI_Component_Renderless_TextField.component(dictMonadAff))({
              render: Magento_Import_UI_Component_TextField.render(dictMonadAff),
              initialState: Data_Show.show(Magento_Import_Data_Categories.showCategory)(st.category)
          })(function ($57) {
              return Data_Maybe.Just.create(HandleTextField.create($57));
          }), Ocelot_Block_Input.addonLeft_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "checkbox";
          }))(Data_Ord.ordUnit)(Magento_Import_UI_Component_Checkbox["_checkbox"])(Data_Unit.unit)(Magento_Import_UI_Component_Renderless_Checkbox.component(dictMonadAff))({
              render: renderCheckbox,
              initialState: st.selected
          })(function ($58) {
              return Data_Maybe.Just.create(HandleCheckbox.create($58));
          }) ]) ]);
      };
  };
  var component = function (dictMonadAff) {
      ...
      return function (v) {
          if (v instanceof AddCategory) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Util.debug(dictMonadAff)("add category"))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $16.categories = Data_Array.snoc(v1.categories)({
          ...
          if (v instanceof ToggleExpand) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $20.expand = Data_HeytingAlgebra.not(Ocelot_Block_Expandable.heytingAlgebraStatus)(st.expand);
                  return $20;
              });
          };
          throw new Error("Failed pattern match at Magento.Import.UI.Container.Categories.Category (line 96, column 16 - line 105, column 51): " + [ v.constructor.name ]);
      };
  };
          ...
          var renderItems = Data_Array.mapWithIndex(function (idx) {
              return function (i) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "item";
                  }))(Data_Ord.ordInt)(_item)(idx)(Magento_Import_UI_Container_Categories_Item.component(dictMonadAff))(i)(Data_Function["const"](Data_Maybe.Nothing.value));
              };
          });
          return Ocelot_Block_Card.innerCard_([ Ocelot_Block_Expandable.heading([ Halogen_HTML_Events.onClick(function ($33) {
              return Data_Maybe.Just.create(Data_Function["const"](ToggleExpand.value)($33));
          }), Ocelot_Block_Expandable.status(v.expand) ])([ Halogen_HTML_Core.text(Data_Show.show(Magento_Import_Data_Skus.showSku)(v.sku)) ]), Ocelot_Block_Expandable.content_(v.expand)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderItems(v.categories))([ Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($34) {
              return Data_Maybe.Just.create(Data_Function["const"](AddCategory.value)($34));
...
(function($PS) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $13.expand = Data_HeytingAlgebra.not(Ocelot_Block_Expandable.heytingAlgebraStatus)(st.expand);
              return $13;
          });
      };
  };
  ...
  var render = function (dictMonadAff) {
      return function (v) {
          ...
          return Ocelot_Block_Card.card_([ Ocelot_Block_Expandable.heading([ Halogen_HTML_Events.onClick(function ($25) {
              return Data_Maybe.Just.create(Data_Function["const"](ToggleExpand.value)($25));
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Magento_Import_UI_Page.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();