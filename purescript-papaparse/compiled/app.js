...
(function($PS) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Toggle) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.putState(Halogen_Query_HalogenM.monadStateHalogenM)(checked))(function () {
                      if (checked) {
                          return Halogen_Query_HalogenM.raise(Checked.value);
                      };
                      return Halogen_Query_HalogenM.raise(Unchecked.value);
                  });
              });
          };
          ...
          throw new Error("Failed pattern match at Magento.Import.UI.Component.Renderless.Checkbox (line 54, column 16 - line 64, column 25): " + [ v.constructor.name ]);
      };
  };                              
...
(function($PS) {
  "use strict";
  $PS["Magento.Import.UI.Container.Category.Item"] = $PS["Magento.Import.UI.Container.Category.Item"] || {};
  var exports = $PS["Magento.Import.UI.Container.Category.Item"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof HandleCheckbox) {
              if (v.value0 instanceof Magento_Import_UI_Component_Renderless_Checkbox.Checked) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $29 = {};
                      for (var $30 in v1) {
              ...
              if (v.value0 instanceof Magento_Import_UI_Component_Renderless_Checkbox.Unchecked) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $32 = {};
                      for (var $33 in v1) {
              ...
              throw new Error("Failed pattern match at Magento.Import.UI.Container.Category.Item (line 122, column 28 - line 130, column 1): " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Magento.Import.UI.Container.Category.Item (line 115, column 16 - line 130, column 1): " + [ v.constructor.name ]);
      };
  };       
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var $51 = Data_Eq.eq(eqValidity)(v1.validity)(Valid.value) && v1.selected === true;
              if ($51) {
  ...
  var render = function (dictMonadAff) {
      return function (st) {
          ...
          return Ocelot_Block_Input.inputGroup_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return Data_Maybe.Just.create(HandleTextField.create($60));
              ...
              return Data_Maybe.Just.create(HandleCheckbox.create($61));
          }) ]) ]);
      };
  };
  var component = function (dictMonadAff) {
...
(function($PS) {
  "use strict";
  $PS["Magento.Import.UI.Container.Category"] = $PS["Magento.Import.UI.Container.Category"] || {};
  var exports = $PS["Magento.Import.UI.Container.Category"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Magento_Import_Data_Categories = $PS["Magento.Import.Data.Categories"];
  var Magento_Import_UI_Container_Category_Item = $PS["Magento.Import.UI.Container.Category.Item"];                
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.queryAll()(new Data_Symbol.IsSymbol(function () {
              return "item";
          }))(Data_Ord.ordInt)(_item)(Halogen_Query.request(Magento_Import_UI_Container_Category_Item.GetCategory.create)))(function (v1) {
          ...
          var renderItems = Data_Array.mapWithIndex(function (idx) {
              return function (i) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "item";
                  }))(Data_Ord.ordInt)(_item)(idx)(Magento_Import_UI_Container_Category_Item.component(dictMonadAff))(i)(Data_Function["const"](Data_Maybe.Nothing.value));
              };
          });
          return Halogen_HTML_Elements.div_(renderItems(v.categories));
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var Halogen_Util = $PS["Halogen.Util"];
  var Magento_Import_Data_Categories = $PS["Magento.Import.Data.Categories"];
  var Magento_Import_UI_Container_Category = $PS["Magento.Import.UI.Container.Category"];                
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
              return "category";
          }))(Data_Ord.ordUnit)(_category)(Data_Unit.unit)(Halogen_Query.request(Magento_Import_UI_Container_Category.GetCategories.create)))(function (v1) {
              return Halogen_Util.debugShow(Data_Maybe.showMaybe(Magento_Import_Data_Categories.showCategoreis))(dictMonadAff)(v1);
          });
      };
  };
  var render = function (dictMonadAff) {
      return function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "category";
          }))(Data_Ord.ordUnit)(_category)(Data_Unit.unit)(Magento_Import_UI_Container_Category.component(dictMonadAff))({
              categories: [ {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("A/B")),
                  validity: false
              }, {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("A/C/D/E")),
                  validity: true
              }, {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("A/F/G")),
                  validity: false
              } ]
          })(Data_Function["const"](Data_Maybe.Nothing.value)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function ($9) {
              return Data_Maybe.Just.create(Data_Function["const"](GetAllValidCategories.value)($9));
          }) ])([ Halogen_HTML_Core.text("getAllCategories") ]) ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
