  ...
  var render = function (dictMonadAff) {
      return function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "categories";
          }))(Data_Ord.ordUnit)(_categories)(Data_Unit.unit)(Magento_Import_UI_Container_Categories.component(dictMonadAff))([ new Data_Tuple.Tuple("FSWT400", [ {
              category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("Finestra Wood Category/Traverse/Components/Cord Draw")),
              validity: false
          }, {
              category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("Finestra Wood Category/Traverse/Components/Baton Draw")),
              validity: true
          } ]), new Data_Tuple.Tuple("CP500", [ {
              category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("Rowley Category/Drapery Hardware/Tracks & Components/Cord Draw Track")),
              validity: true
          }, {
              ...
              validity: false
          } ]) ])(Data_Function["const"](Data_Maybe.Nothing.value)), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($9) {
              return Data_Maybe.Just.create(Data_Function["const"](GetAllValidCategories.value)($9));
          }) ])([ Halogen_HTML_Core.text("getAllValidCategories") ]) ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
