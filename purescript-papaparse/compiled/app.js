...
(function($PS) {
  ...
  var readCategory = new Data_String_Read.Read(function ($6) {
      return Data_Maybe.Just.create(Category(Data_Functor.map(Data_Functor.functorArray)(Data_String_Common.trim)(Data_String_Common.split("/")($6))));
  });
  var newtypeCategory = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Category);
  var showCategory = new Data_Show.Show(function ($8) {
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("/")(Data_Newtype.unwrap(newtypeCategory)($8));
  });
  var newtypeCategories = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Categories);
  var showCategoreis = new Data_Show.Show(function ($9) {
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showCategory))(Data_Newtype.unwrap(newtypeCategories)($9)));
  });
...
(function($PS) {
  ...
  var parseSingleColumn = function (columnName) {
      return function (v) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(Column)(Data_Traversable["for"](Data_Maybe.applicativeMaybe)(Data_Traversable.traversableArray)(v)(function (row) {
  ...
  var parseRowTable = function (v) {
      ...
      if (v1 instanceof Data_Maybe.Just) {
          return Data_Maybe.Just.create(RowTable(Data_Functor.map(Data_Functor.functorArray)(function ($25) {
              return Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(Data_Array.zip(v1.value0.head)($25));
          })(v1.value0.tail)));
      };
      throw new Error("Failed pattern match at Magento.Import.UI.Data.File (line 41, column 29 - line 44, column 71): " + [ v1.constructor.name ]);
  };
...
(function($PS) {
  ...
  var showBatchValidationResult = Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showString)(Data_Show.showArray(Data_Show.showString)));
  var decodeJsonBatchValidationResult = Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonTuple(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString)));
  var batchValidate = function (col) {
      return Data_Functor.map(Effect_Aff.functorAff)(function (res) {
          return {
              body: Control_Bind.bind(Data_Either.bindEither)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Affjax_ResponseFormat.printResponseFormatError)(res.body))(Data_Argonaut_Decode_Class.decodeJson(decodeJsonBatchValidationResult)),
              headers: res.headers,
              status: res.status,
  ...
  exports["showBatchValidationResult"] = showBatchValidationResult;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
(function($PS) {
  ...
  var defaultInitialState = {
      ...
      expand: Ocelot_Block_Expandable.Expanded.value,
      ...
      return function (v) {
          if (v instanceof HandleFilePicker) {
              if (v.value0 instanceof Magento_Import_UI_Container_TabularFilePicker.FileLoaded) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $15.file = new Data_Maybe.Just(v.value0.value0);
                      return $15;
                  }))(function () {
                      ...
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              ...
                              message: Data_Show.show(Data_Show.showString)("Failure when parsing File")
                          }))));
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Util.debug(dictMonadAff)("HandleFilePicker > FileLoaded > parseRowTable"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  var $19 = {};
                                  for (var $20 in v2) {
                                  ...
                                  $19.rowTable = new Data_Maybe.Just(v1.value0);
                                  return $19;
                              }))(function () {
                                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Magento_Import_UI_Data_File.parseSingleColumn(Magento_Import_Data_Categories.columnName)(v1.value0))))(function (v2) {
                                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Halogen_Query_HalogenM.monadHalogenM))(Control_Monad_Maybe_Trans.MaybeT(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(function ($35) {
                                          return Data_Either.hush((function (v3) {
                                              return v3.body;
                                          })($35));
                                      })(Magento_Import_UI_Api_Category.batchValidate(v2)))))(function (v3) {
                                          return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Halogen_Query_HalogenM.monadHalogenM)(Halogen_Util.debugShow(Magento_Import_UI_Api_Category.showBatchValidationResult)(dictMonadAff)(v3));
                                      });
                                  })));
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Magento.Import.UI.Page (line 132, column 7 - line 145, column 38): " + [ v1.constructor.name ]);
                  });
              };
              ...
              throw new Error("Failed pattern match at Magento.Import.UI.Page (line 129, column 25 - line 149, column 77): " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof HandleOptionPanel) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $30.options = v.value0.value0;
                  return $30;
              });
          };
          throw new Error("Failed pattern match at Magento.Import.UI.Page (line 128, column 16 - line 162, column 34): " + [ v.constructor.name ]);
      };
  };
  var render = function (dictMonadAff) {
      return function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return "optionPanel";
          }))(Data_Ord.ordUnit)(_optionPanel)(Data_Unit.unit)(Magento_Import_UI_Container_OptionPanel.component(dictMonadAff))(Data_Unit.unit)(function ($36) {
              return Data_Maybe.Just.create(HandleOptionPanel.create($36));
          }), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($37) {
              return Data_Maybe.Just.create(Data_Function["const"](OpenOptionPanel.value)($37));
          }) ])([ Halogen_HTML_Core.text("Open Option Panel") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "filePicker";
          }))(Data_Ord.ordUnit)(_filePicker)(Data_Unit.unit)(Magento_Import_UI_Container_TabularFilePicker.component(dictMonadAff))(Data_Unit.unit)(function ($38) {
              return Data_Maybe.Just.create(HandleFilePicker.create($38));
              ...
              initCategories: [ new Data_Tuple.Tuple("A", [ {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("A/B/C")),
                  validity: false
              }, {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("A/E/F")),
                  validity: true
              } ]), new Data_Tuple.Tuple("M", [ {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("D")),
                  validity: true
              }, {
                  category: Data_Maybe.fromMaybe(Data_Monoid.mempty(Magento_Import_Data_Categories.monoidCategory))(Data_String_Read.read(Magento_Import_Data_Categories.readCategory)("EF")),
                  validity: false
              } ]) ],
              visibility: Data_Maybe.fromMaybe(true)(Data_Map_Internal.lookup(Data_Ord.ordString)("category")(st.options))
          })(Data_Function["const"](Data_Maybe.Nothing.value)), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($39) {
              return Data_Maybe.Just.create(Data_Function["const"](GetAllValidCategories.value)($39));
          }) ])([ Halogen_HTML_Core.text("getAllValidCategories") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($40) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup.Success.value,
                  message: "success"
              }))($40));
          }) ])([ Halogen_HTML_Core.text("Success") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($41) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup.Warning.value,
                  message: "warning"
              }))($41));
          }) ])([ Halogen_HTML_Core.text("Warning") ]), Ocelot_Block_Button.button([ Halogen_HTML_Events.onClick(function ($42) {
              return Data_Maybe.Just.create(Data_Function["const"](new PopupTest({
                  status: Magento_Import_UI_Container_Popup["Error"].value,
