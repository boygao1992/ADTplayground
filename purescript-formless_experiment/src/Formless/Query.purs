...
asyncSetValidate
  ...
  -> a
  -> Query pq cq cs form m a
asyncSetValidate ms sym i = ModifyValidateAsync ms (wrap (inj sym (wrap (const i))))
...
asyncSetValidate_
  ...
  -> i
  -> Query pq cq cs form m Unit
asyncSetValidate_ ms sym i = ModifyValidateAsync ms (wrap (inj sym (wrap (const i)))) unit
...
asyncModifyValidate
  ...
  -> a
  -> Query pq cq cs form m a
asyncModifyValidate ms sym f = ModifyValidateAsync ms (wrap (inj sym (wrap f)))
...
asyncModifyValidate_
  ...
  -> (i -> i)
  -> Query pq cq cs form m Unit
asyncModifyValidate_ ms sym f = ModifyValidateAsync ms (wrap (inj sym (wrap f))) unit
