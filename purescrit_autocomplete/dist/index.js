...
(function(exports) {
          ...
          return function (v1) {
              ...
              var updateKey = function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Main line 143, column 5 - line 143, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              ...
              throw new Error("Failed pattern match at Main line 149, column 5 - line 171, column 71: " + [ event.constructor.name ]);
          };
      };
  };
  ...
  var mouseTransition = function (v) {
      return function (event) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Main line 185, column 3 - line 191, column 63: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof KeyUp) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v2.value0 && v2.value1) {
                          return withCmds(v1)(new Data_Maybe.Just(WindowPushUpperBoundary.value));
                      };
                      if (v2.value0 && !v2.value1) {
                          return withCmds((function () {
                              var $81 = {};
                      ...
                      throw new Error("Failed pattern match at Main line 98, column 9 - line 106, column 54: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 88, column 5 - line 106, column 54: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  ...
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v2.value0 && v2.value1) {
                          return withCmds(v1)(new Data_Maybe.Just(WindowPushLowerBoundary.value));
                      };
                      if (v2.value0 && !v2.value1) {
                          return withCmds((function () {
                              var $104 = {};
                      ...
                      throw new Error("Failed pattern match at Main line 119, column 9 - line 127, column 54: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 109, column 5 - line 127, column 54: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 86, column 3 - line 127, column 54: " + [ event.constructor.name ]);
          };
      };
  };
  var empty = {
      ...
      return function (event) {
          return function (state) {
              ...
              if (event instanceof Reset) {
                  return new Data_Tuple.Tuple(empty, Data_Maybe.Nothing.value);
              };
              throw new Error("Failed pattern match at Main line 65, column 38 - line 73, column 24: " + [ event.constructor.name ]);
          };
      };
  };
  var defaultConfig = {
  ...
  var $$eval = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
          var v2 = stateTransition(defaultConfig)(v.value0)(v1);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v2.value0))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Main line 218, column 3 - line 220, column 25: " + [ v2.value1.constructor.name ]);
              })())(function () {
