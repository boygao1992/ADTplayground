...
(function(exports) {
          ...
          return function (v1) {
              ...
              var updateKey = function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Main line 149, column 5 - line 149, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              if (event instanceof ScrollUp) {
                  ...
                  var v2 = (function () {
                      var $36 = windowAtUpperBoundary(v1.head);
                      if ($36) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $38.key = updateKey(v1.key)(v2.value0);
                      $38.head = v2.value0;
                      return $38;
                  })(v2.value1);
              };
              if (event instanceof ScrollDown) {
                  ...
                  var v2 = (function () {
                      var $43 = windowAtLowerBoundary(v1.head);
                      if ($43) {
              ...
              throw new Error("Failed pattern match at Main line 155, column 5 - line 177, column 69: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $58.mouse = new Data_Maybe.Just(event.value0);
                      return $58;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $62.mouse = Data_Maybe.Nothing.value;
                      return $62;
                  })(Data_Maybe.Nothing.value);
              };
              ...
              throw new Error("Failed pattern match at Main line 195, column 3 - line 201, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $75.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $75;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $86.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $86.head = v1.head - 1 | 0;
                              return $86;
                          })(Data_Maybe.Nothing.value);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 100, column 9 - line 108, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 90, column 5 - line 108, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $98.key = new Data_Maybe.Just(v1.head);
                          return $98;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $109.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $109.head = v1.head + 1 | 0;
                              return $109;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v2.value0 && !v2.value1) {
                      ...
                      throw new Error("Failed pattern match at Main line 121, column 9 - line 129, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 111, column 5 - line 129, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 88, column 3 - line 129, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  var empty = {
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Main line 63, column 38 - line 71, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  var defaultConfig = {
  ...
  var $$eval = function (v) {
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(v2.value0))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Main line 228, column 3 - line 230, column 25: " + [ v2.value1.constructor.name ]);
              })())(function () {
  ...
  var ui = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](empty),
      render: render,
      "eval": $$eval,
