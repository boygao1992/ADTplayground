...
(function(exports) {
          ...
          return function (v1) {
              ...
              var updateKey = function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Main line 155, column 5 - line 155, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              if (event instanceof ScrollUp) {
                  ...
                  var v2 = (function () {
                      var $43 = windowAtUpperBoundary(v1.head);
                      if ($43) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $45.key = updateKey(v1.key)(v2.value0);
                      $45.head = v2.value0;
                      return $45;
                  })(v2.value1);
              };
              if (event instanceof ScrollDown) {
                  ...
                  var v2 = (function () {
                      var $50 = windowAtLowerBoundary(v1.head);
                      if ($50) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $52.key = updateKey(v1.key)(v2.value0);
                      $52.head = v2.value0;
                      return $52;
                  })(v2.value1);
              };
              throw new Error("Failed pattern match at Main line 161, column 5 - line 183, column 69: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $65.mouse = new Data_Maybe.Just(event.value0);
                      return $65;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $69.mouse = Data_Maybe.Nothing.value;
                      return $69;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $72.mouse = new Data_Maybe.Just(event.value0);
                      return $72;
                  })(new Data_Maybe.Just(new Select(event.value0)));
              };
              throw new Error("Failed pattern match at Main line 201, column 3 - line 207, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $82.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $82;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $93.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $93.head = v1.head - 1 | 0;
                              return $93;
                          })(Data_Maybe.Nothing.value);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 106, column 9 - line 114, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 96, column 5 - line 114, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $105.key = new Data_Maybe.Just(v1.head);
                          return $105;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $116.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $116.head = v1.head + 1 | 0;
                              return $116;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v2.value0 && !v2.value1) {
                      ...
                      throw new Error("Failed pattern match at Main line 127, column 9 - line 135, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 117, column 5 - line 135, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 94, column 3 - line 135, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  var empty = {
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Main line 69, column 38 - line 77, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  var defaultConfig = {
  ...
  var $$eval = function (v) {
      var _stateTransition = stateTransition(defaultConfig);
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          return v1.internal;
      }))(function (v1) {
          var v2 = _stateTransition(v.value0)(v1);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $138.internal = v2.value0(st.internal);
              return $138;
          }))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Main line 242, column 3 - line 244, column 25: " + [ v2.value1.constructor.name ]);
              })())(function () {
          ...
          return function (v) {
              var toUl = function (e) {
                  var v1 = function (v2) {
                      ...
                      throw new Error("Failed pattern match at Main line 209, column 1 - line 209, column 93: " + [ e.constructor.name ]);
                  };
                  if (e instanceof Data_Maybe.Just) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_(Data_Foldable.foldl(dictFoldable)(function (acc) {
                          return function (a) {
                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc)([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(li(a)) ]) ]);
                          };
                      })([  ])(e.value0)) ]);
                  };
                  return v1(true);
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(buildComponent(Data_Foldable.foldableArray)(Data_Show.show(Data_Show.showInt))({
          internal: empty,
          external: new Data_Maybe.Just([ 1, 2, 3 ])
      }))(Data_Unit.unit)(v);
  }));
