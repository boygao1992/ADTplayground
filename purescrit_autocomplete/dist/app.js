          ...
          return function (v1) {
              ...
              var updateKey = function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Select line 176, column 5 - line 176, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              if (event instanceof ScrollUp) {
                  ...
                  var v2 = (function () {
                      var $48 = windowAtUpperBoundary(v1.head);
                      if ($48) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $50.key = updateKey(v1.key)(v2.value0);
                      $50.head = v2.value0;
                      return $50;
                  })(v2.value1);
              };
              if (event instanceof ScrollDown) {
                  ...
                  var v2 = (function () {
                      var $55 = windowAtLowerBoundary(v1.head);
                      if ($55) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $57.key = updateKey(v1.key)(v2.value0);
                      $57.head = v2.value0;
                      return $57;
                  })(v2.value1);
              };
              throw new Error("Failed pattern match at Select line 182, column 5 - line 204, column 69: " + [ event.constructor.name ]);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $70.mouse = new Data_Maybe.Just(event.value0);
                      return $70;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $74.mouse = Data_Maybe.Nothing.value;
                      return $74;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $77.mouse = new Data_Maybe.Just(event.value0);
                      return $77;
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $87.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $87;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $92.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $92;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v3 && v2) {
                          return withCmds(function (v4) {
                              ...
                              $95.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $95.head = v1.head - 1 | 0;
                              return $95;
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $98.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              return $98;
                          })(Data_Maybe.Nothing.value);
                      };
              ...
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $103.key = new Data_Maybe.Just(v1.head);
                          return $103;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v3 && !v2) {
                          return withCmds(function (v4) {
                              ...
                              $114.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $114;
                          })(Data_Maybe.Nothing.value);
                      };
      ...
      return function (v) {
          if (v instanceof Sync) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $127.external = Data_Maybe.Just.create(Data_Foldable.foldl(dictFoldable)(function (acc) {
                      return function (x) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $140.internal = v3.value0(st.internal);
                          return $140;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Select line 303, column 3 - line 305, column 25: " + [ v3.value1.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          throw new Error("Failed pattern match at Select line 281, column 1 - line 281, column 106: " + [ v.constructor.name ]);
      };
  };
  var defaultConfig = {
      windowSize: 3,
      ...
      return function (v) {
          ...
          var toUl = function (e) {
              var v1 = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Select line 230, column 1 - line 230, column 95: " + [ e.constructor.name ]);
              };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          ...
          }))([  ])(Data_Maybe.maybe(v)(Control_Category.identity(Control_Category.categoryFn))(v1)))(function (v2) {
