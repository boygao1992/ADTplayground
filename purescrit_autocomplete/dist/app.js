...
(function(exports) {
          ...
          return function (v1) {
              ...
              var updateKey = function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Main line 173, column 5 - line 173, column 47: " + [ v2.constructor.name, v3.constructor.name ]);
                  };
              };
              ...
              throw new Error("Failed pattern match at Main line 179, column 5 - line 201, column 69: " + [ event.constructor.name ]);
          };
      };
  };
  var onKeyUp = function (document) {
      return function (fn) {
          ...
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($172) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($172));
              })();
              Web_Event_EventTarget.addEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(v)(false)(target)();
              return Web_Event_EventTarget.removeEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(v)(false)(target);
          };
      };
  };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $71.mouse = new Data_Maybe.Just(event.value0);
                      return $71;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $75.mouse = Data_Maybe.Nothing.value;
                      return $75;
                  })(Data_Maybe.Nothing.value);
              };
              if (event instanceof MouseClick) {
                  return withCmds(function (v2) {
                      ...
                      $78.mouse = new Data_Maybe.Just(event.value0);
                      return $78;
                  })(new Data_Maybe.Just(new Select(event.value0)));
              };
              throw new Error("Failed pattern match at Main line 219, column 3 - line 225, column 61: " + [ event.constructor.name ]);
          };
      };
  };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $88.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $88;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var v2 = new Data_Tuple.Tuple(windowAtUpperBoundary(v1.head), aboveWindow(v1.key.value0 - 1 | 0)(v1.head));
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $99.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $99.head = v1.head - 1 | 0;
                              return $99;
                          })(Data_Maybe.Nothing.value);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 124, column 9 - line 132, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 114, column 5 - line 132, column 52: " + [ v1.key.constructor.name ]);
              };
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $111.key = new Data_Maybe.Just(v1.head);
                          return $111;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      var v2 = new Data_Tuple.Tuple(windowAtLowerBoundary(v1.head), belowWindow(v1.key.value0 + 1 | 0)(v1.head));
                      if (v2.value0 && v2.value1) {
                      ...
                      if (v2.value0 && !v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $117.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              return $117;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $122.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $122.head = v1.head + 1 | 0;
                              return $122;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v2.value0 && !v2.value1) {
                      ...
                      throw new Error("Failed pattern match at Main line 145, column 9 - line 153, column 52: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 135, column 5 - line 153, column 52: " + [ v1.key.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 112, column 3 - line 153, column 52: " + [ event.constructor.name ]);
          };
      };
  };
  var empty = {
  ...
  var stateTransition = function (config) {
      return function (event) {
          return function (state) {
              ...
              throw new Error("Failed pattern match at Main line 87, column 38 - line 95, column 32: " + [ event.constructor.name ]);
          };
      };
  };
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(onKeyUp(v1))(function ($173) {
                  return Data_Maybe.Just.create(Halogen_Query.request(HandleKey.create($173)));
              })))(function () {
      ...
      if (v instanceof HandleKey) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Web_UIEvent_KeyboardEvent.key(v.value0))))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $154.internal = v3.value0(st.internal);
                      return $154;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Main line 292, column 3 - line 294, column 25: " + [ v3.value1.constructor.name ]);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
      ...
      throw new Error("Failed pattern match at Main line 268, column 1 - line 268, column 78: " + [ v.constructor.name ]);
  };
  var defaultConfig = {
      windowSize: 3,
      listSize: 10
          ...
          return function (v) {
              ...
              var toUl = function (e) {
                  var v1 = function (v2) {
                      ...
                      throw new Error("Failed pattern match at Main line 227, column 1 - line 227, column 102: " + [ e.constructor.name ]);
                  };
  ...
  var buildComponent = function (dictFoldable) {
      return function (li) {
          return function (initialState) {
              ...
              return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)(spec);
          };
      };
  };
