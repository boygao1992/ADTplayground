      ...
      return function (event) {
          return function (v1) {
              ...
              if (event instanceof ScrollUp) {
                  ...
                  var v2 = (function () {
                      var $46 = windowAtUpperBoundary(v1.head);
                      if ($46) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $48.key = updateKey(v1.key)(v2.value0);
                      $48.head = v2.value0;
                      return $48;
                  })(v2.value1);
              };
              if (event instanceof ScrollDown) {
                  ...
                  var v2 = (function () {
                      var $53 = windowAtLowerBoundary(v1.head);
                      if ($53) {
                  ...
                  return withCmds(function (v3) {
                      ...
                      $55.key = updateKey(v1.key)(v2.value0);
                      $55.head = v2.value0;
                      return $55;
                  })(v2.value1);
              };
          ...
          return function (v1) {
              if (event instanceof MouseEnter) {
                  return withCmds(function (v2) {
                      ...
                      $68.mouse = new Data_Maybe.Just(event.value0);
                      return $68;
              ...
              if (event instanceof MouseLeave) {
                  return withCmds(function (v2) {
                      ...
                      $72.mouse = Data_Maybe.Nothing.value;
                      return $72;
                  })(Data_Maybe.Nothing.value);
              };
              ...
              if (event instanceof KeyUp) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $85.key = new Data_Maybe.Just((v1.head + v.windowSize | 0) - 1 | 0);
                          return $85;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $96.key = Data_Maybe.Just.create(v1.key.value0 - 1 | 0);
                              $96.head = v1.head - 1 | 0;
                              return $96;
                          })(Data_Maybe.Nothing.value);
                      };
              ...
              if (event instanceof KeyDown) {
                  if (v1.key instanceof Data_Maybe.Nothing) {
                      return withCmds(function (v2) {
                          ...
                          $108.key = new Data_Maybe.Just(v1.head);
                          return $108;
                      })(Data_Maybe.Nothing.value);
                  };
                  if (v1.key instanceof Data_Maybe.Just) {
                      ...
                      if (!v2.value0 && v2.value1) {
                          return withCmds(function (v3) {
                              ...
                              $119.key = Data_Maybe.Just.create(v1.key.value0 + 1 | 0);
                              $119.head = v1.head + 1 | 0;
                              return $119;
                          })(Data_Maybe.Nothing.value);
                      };
                      if (!v2.value0 && !v2.value1) {
