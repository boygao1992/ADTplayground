  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof ToggleState) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)))(function () {
          ...
          throw new Error("Failed pattern match at ComponentA line 41, column 5 - line 41, column 57: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at ComponentB line 44, column 5 - line 44, column 57: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
...
(function(exports) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at ComponentC line 43, column 5 - line 43, column 57: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]("Hi"),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  exports["component"] = component;
})(PS["ComponentC"] = PS["ComponentC"] || {});
(function(exports) {
    "use strict";
  var ComponentA = PS["ComponentA"];
  var ComponentB = PS["ComponentB"];
  var ComponentC = PS["ComponentC"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Data_Either = PS["Data.Either"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ComponentA") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(ComponentA.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ComponentB") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(ComponentB.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ComponentC") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(ComponentC.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last observed states:") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("ComponentA: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showBoolean))(state.a)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("ComponentB: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(state.b)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("ComponentC: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.c)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReadStates.create)) ])([ Halogen_HTML_Core.text("Check states now") ]) ]);
      };
      var initialState = {
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Container.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Examples.ComponentMultitype.Main"] = PS["Examples.ComponentMultitype.Main"] || {});
PS["Examples.ComponentMultitype.Main"].main();
},{}]},{},[1]);
