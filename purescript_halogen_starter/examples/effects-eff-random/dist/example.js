...
(function(exports) {
  ...
  var UpdateNumber = (function () {
      function UpdateNumber(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateNumber.create = function (value0) {
          return function (value1) {
              return new UpdateNumber(value0, value1);
          };
      };
      return UpdateNumber;
  })();
  var RandomNew = (function () {
      ...
      RandomNew.value = new RandomNew();
      return RandomNew;
  })();
  var render = function (state) {
      var value = Data_Maybe.maybe("No number generated yet")(Data_Show.show(Data_Show.showNumber))(state);
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Random number") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current value: " + value) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Regenerate.create)) ])([ Halogen_HTML_Core.text("Generate new nubmer") ]) ]);
  };
  var initialState = Data_Maybe.Nothing.value;
  var $$eval = function (v) {
      if (v instanceof Regenerate) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(RandomNew.value))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          });
      };
      if (v instanceof UpdateNumber) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new Data_Maybe.Just(v.value0)))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Examples.EffectsEffRandom.Main line 43, column 1 - line 43, column 55: " + [ v.constructor.name ]);
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return v1.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Random.random))(function (v3) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("New number is generated" + Data_Show.show(Data_Show.showNumber)(v3))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(v1.query(Halogen_Query.action(UpdateNumber.create(v3))))(function () {
  ...
  exports["RandomNew"] = RandomNew;
  exports["render"] = render;
  exports["eval"] = $$eval;
  exports["ui"] = ui;
  exports["main"] = main;
})(PS["Examples.EffectsEffRandom.Main"] = PS["Examples.EffectsEffRandom.Main"] || {});
PS["Examples.EffectsEffRandom.Main"].main();
},{}]},{},[1]);
