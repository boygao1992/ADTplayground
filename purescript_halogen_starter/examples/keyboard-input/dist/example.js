...
(function(exports) {
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hold down the shift key and type some characters!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press ENTER or RETURN to clear and remove the event listeners.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.chars) ]) ]);
  };
  var onKeyUp = function (document) {
      return function (fn) {
          var target = Web_HTML_HTMLDocument.toEventTarget(document);
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($19) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($19));
              })();
  ...
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(onKeyUp(v1))(function ($20) {
                  return Data_Maybe.Just.create(Halogen_Query.request(HandleKey.create($20)));
              })))(function () {
      ...
      if (v instanceof HandleKey) {
          if (Web_UIEvent_KeyboardEvent.shiftKey(v.value0)) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                  var $$char = Web_UIEvent_KeyboardEvent.key(v.value0);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_String_CodePoints.length($$char) === 1)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $10 = {};
                      for (var $11 in st) {
          ...
          if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Enter") {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
      ...
      throw new Error("Failed pattern match at Examples.KeyboardInput.Main line 58, column 1 - line 58, column 54: " + [ v.constructor.name ]);
  };
  var ui = Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
  ...
  exports["ui"] = ui;
  exports["main"] = main;
})(PS["Examples.KeyboardInput.Main"] = PS["Examples.KeyboardInput.Main"] || {});
PS["Examples.KeyboardInput.Main"].main();
},{}]},{},[1]);
