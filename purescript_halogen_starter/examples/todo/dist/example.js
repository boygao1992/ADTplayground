...
(function(exports) {
  ...
  var IsCompleted = (function () {
      function IsCompleted(value0) {
          this.value0 = value0;
      };
      IsCompleted.create = function (value0) {
          return new IsCompleted(value0);
      };
      return IsCompleted;
  })();
  var ToggleCompletedFromParent = (function () {
      function ToggleCompletedFromParent(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ToggleCompletedFromParent.create = function (value0) {
          return function (value1) {
              return new ToggleCompletedFromParent(value0, value1);
          };
      };
      return ToggleCompletedFromParent;
  })();
  var Removed = (function () {
      function Removed() {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.title("Mark as completed"), Halogen_HTML_Properties.checked(state.completed), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(ToggleCompleted.create)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Task description"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.description), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateDescription.create)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("Remove task"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Remove.create)) ])([ Halogen_HTML_Core.text("x") ]) ]);
      };
      var initialState = {
          description: "",
          completed: false
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ToggleCompleted) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Halogen_Query_HalogenM.raise(new Toggled(v.value0));
              }));
          };
          if (v instanceof Remove) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Halogen_Query_HalogenM.raise(Removed.value));
          };
          if (v instanceof IsCompleted) {
              return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.completed;
              }));
          };
          if (v instanceof ToggleCompletedFromParent) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $18 = {};
                  for (var $19 in v1) {
                  ...
                  $18.completed = v.value0;
                  return $18;
              }));
          };
          throw new Error("Failed pattern match at Task line 64, column 5 - line 64, column 57: " + [ v.constructor.name ]);
      };
  ...
  exports["ToggleCompletedFromParent"] = ToggleCompletedFromParent;
  exports["Removed"] = Removed;
...
(function(exports) {
  ...
  var AllDone = (function () {
      function AllDone(value0) {
          this.value0 = value0;
      };
      AllDone.create = function (value0) {
          return new AllDone(value0);
      };
      return AllDone;
  })();
  var HandleTaskMessage = (function () {
      function HandleTaskMessage(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleTaskMessage.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleTaskMessage(value0, value1, value2);
              };
          };
      };
      return HandleTaskMessage;
  })();
  var showChildSlot = Data_Show.showInt;
  var ordChildSlot = Data_Ord.ordInt;
  var eqChildSlot = Data_Eq.eqInt;
  var component = (function () {
      var renderTask = function (id) {
          return Halogen_HTML.slot(id)(Task.component)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleTaskMessage.create(id)));
      };
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Todo list") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(NewTask.create)) ])([ Halogen_HTML_Core.text("New Task") ]) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderTask)(v.tasks)), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.numCompleted) + (" / " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(v.tasks)) + " complete"))) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AllDone.create)) ])([ Halogen_HTML_Core.text("All done") ]) ]);
      };
      var initialState = {
          tasks: [  ],
          nextId: 0,
      ...
      var $$eval = function (v) {
          if (v instanceof NewTask) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $14 = {};
                  for (var $15 in state) {
                  ...
                  $14.nextId = state.nextId + 1 | 0;
                  $14.tasks = Data_Array.snoc(state.tasks)(state.nextId);
                  return $14;
              }));
          };
          if (v instanceof AllDone) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.queryAll(ordChildSlot)(Halogen_Query.request(Task.ToggleCompletedFromParent.create(true))))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(Data_Map_Internal.showMap(showChildSlot)(Data_Show.showBoolean))(v1))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $19.numCompleted = Data_Map_Internal.size(Data_Map_Internal.filter(ordChildSlot)(Control_Category.identity(Control_Category.categoryFn))(v1));
                          return $19;
                      });
                  });
              }));
          };
          if (v instanceof HandleTaskMessage) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)((function () {
                  if (v.value1 instanceof Task.Removed) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqChildSlot)(v.value0)(Halogen_Query.request(Task.IsCompleted.create)))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.fromMaybe(false)(v1))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              var $25 = {};
                              for (var $26 in state) {
                              ...
                              $25.numCompleted = state.numCompleted - 1 | 0;
                              return $25;
                          })))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  var $28 = {};
                                  ...
                                  $28.tasks = Data_Array.filter(function (v3) {
                                      return v3 !== v.value0;
                                  })(state.tasks);
                                  return $28;
                              });
                  ...
                  if (v.value1 instanceof Task.Toggled) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $32.numCompleted = (function () {
                              if (v.value1.value0) {
                                  return state.numCompleted + 1 | 0;
                              };
                              return state.numCompleted - 1 | 0;
                          })();
                          return $32;
                      }))(function () {
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("Toggled: " + Data_Show.show(Data_Show.showInt)(v.value0)));
                      });
                  };
                  throw new Error("Failed pattern match at List line 89, column 7 - line 97, column 52: " + [ v.value1.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at List line 81, column 5 - line 81, column 77: " + [ v.constructor.name ]);
      };
  ...
  exports["HandleTaskMessage"] = HandleTaskMessage;
  exports["component"] = component;
  exports["eqChildSlot"] = eqChildSlot;
  exports["ordChildSlot"] = ordChildSlot;
  exports["showChildSlot"] = showChildSlot;
})(PS["List"] = PS["List"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(List.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Examples.Todo.Main"] = PS["Examples.Todo.Main"] || {});
PS["Examples.Todo.Main"].main();
},{}]},{},[1]);
