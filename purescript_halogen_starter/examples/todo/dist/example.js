      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ToggleCompleted) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $10.completed = v.value0;
                  return $10;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Toggled(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof Remove) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(Removed.value))(function () {
      ...
      var $$eval = function (v) {
          if (v instanceof NewTask) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $13.nextId = state.nextId + 1 | 0;
                  $13.tasks = Data_Array.snoc(state.tasks)(state.nextId);
                  return $13;
              }));
          };
          if (v instanceof AllDone) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.queryAll(ordChildSlot)(Halogen_Query.action(Task.ToggleCompleted.create(true))))(function (v1) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(Data_Map_Internal.showMap(showChildSlot)(Data_Unit.showUnit))(v1)));
              }));
          };
                  ...
                  if (v.value1 instanceof Task.Removed) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqChildSlot)(v.value0)(Halogen_Query.request(Task.IsCompleted.create)))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.fromMaybe(false)(v1))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              ...
                              $21.numCompleted = state.numCompleted - 1 | 0;
                              return $21;
                          })))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $24.tasks = Data_Array.filter(function (v3) {
                                      return v3 !== v.value0;
                                  })(state.tasks);
                                  return $24;
                              });
