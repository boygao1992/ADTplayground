...
(function(exports) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Examples.DriverIO.Main line 40, column 1 - line 40, column 63: " + [ v.constructor.name ]);
  };
  var component_button = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(component_button)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(v1.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (v2) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("Button was toggled to: " + Data_Show.show(Data_Show.showBoolean)(v2.value0))))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
              });
          })))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(v1.query(Halogen_Query.action(Toggle.create)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(v1.query(Halogen_Query.action(Toggle.create)))(function () {
                      return v1.query(Halogen_Query.action(Toggle.create));
                  });
              });
          });
      });
  ...
  exports["eval"] = $$eval;
  exports["component_button"] = component_button;
  exports["main"] = main;
})(PS["Examples.DriverIO.Main"] = PS["Examples.DriverIO.Main"] || {});
PS["Examples.DriverIO.Main"].main();
},{}]},{},[1]);
