...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Prelude = PS["Prelude"];
  var safeFromHexString = function ($18) {
      return Data_Maybe.fromMaybe(Color.white)(Color.fromHexString($18));
  };
...
(function(exports) {
  ...
  var Color = PS["Color"];                 
  var orange = CSSUtils.safeFromHexString("#f96855");
...
(function(exports) {
  ...
  var wheel = "wheel";
  exports["wheel"] = wheel;
})(PS["Web.UIEvent.WheelEvent.EventTypes"] = PS["Web.UIEvent.WheelEvent.EventTypes"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS = PS["CSS"];
  ...
  var OnScroll = (function () {
      function OnScroll(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnScroll.create = function (value0) {
          return function (value1) {
              return new OnScroll(value0, value1);
          };
      };
      return OnScroll;
  })();
  var scrollRef = "scroll-control";
  var render = function (state) {
      var noise = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Setting the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("width") ]), Halogen_HTML_Core.text(" of a block-level element will prevent it from stretching out to the edges of its container to the left and right. Then, you can set the left and right margins to "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("auto") ]), Halogen_HTML_Core.text(" to horizontally center that element within its container. The element will take up the width you specify, then the remaining space will be split evenly between the two margins.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The only problem occurs when the browser window is narrower than the width of your element. The browser resolves this by creating a horizontal scrollbar on the page. Let's improve the situation...") ]) ]);
      return Halogen_HTML_Elements.div_([ noise, noise, noise, noise, Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(100.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(100.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.orange))(function () {
                      return CSS_Geometry.top(CSS_Size.px(state.initialY + state.deltaY * state.speed));
                  });
              });
          });
      })), Halogen_HTML_Properties.ref(scrollRef) ])([  ]) ]);
  };
  var initialState = {
      initialY: 0.0,
      deltaY: 0.0,
  ...
  var addWheelEventHandler = function (document) {
      return function (fn) {
          var target = Web_HTML_HTMLDocument.toEventTarget(document);
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($31) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_WheelEvent.fromEvent($31));
              })();
              Web_Event_EventTarget.addEventListener(Web_UIEvent_WheelEvent_EventTypes.wheel)(v)(false)(target)();
              return Web_Event_EventTarget.removeEventListener(Web_UIEvent_WheelEvent_EventTypes.wheel)(v)(false)(target);
          };
      };
  };
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addWheelEventHandler(v1))(function ($32) {
                  return Data_Maybe.Just.create(Halogen_Query.request(OnScroll.create($32)));
              })))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(scrollRef))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.innerHeight)(Web_HTML.window)))(function (v3) {
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLElement.offsetTop(v2.value0)))(function (v4) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      ...
                                      var initialY = -v5 * (v4 - Data_Int.toNumber(v3));
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v6) {
                                          ...
                                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showNumber)(initialY));
                                      });
                                  });
                              });
                          };
                          ...
                          throw new Error("Failed pattern match at ViewComponent line 111, column 3 - line 119, column 16: " + [ v2.constructor.name ]);
                      });
                  });
              });
          }));
      ...
      if (v instanceof OnScroll) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $26.deltaY = Data_Ord.max(Data_Ord.ordNumber)(0.0)(v1 + Web_UIEvent_WheelEvent.deltaY(v.value0));
                  return $26;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showNumber)(Data_Ord.max(Data_Ord.ordNumber)(0.0)(v1 + Web_UIEvent_WheelEvent.deltaY(v.value0)))))(function () {
      ...
      throw new Error("Failed pattern match at ViewComponent line 104, column 1 - line 104, column 54: " + [ v.constructor.name ]);
  };
  var component = function (body) {
      var spec$prime = {
  ...
  exports["addWheelEventHandler"] = addWheelEventHandler;
  exports["initialState"] = initialState;
  exports["Init"] = Init;
  exports["OnScroll"] = OnScroll;
  exports["scrollRef"] = scrollRef;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(function (v1) {
          return Halogen_VDom_Driver.runUI(ViewComponent.component(v))(Data_Unit.unit)(Data_Maybe.fromMaybe(v)(v1));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
